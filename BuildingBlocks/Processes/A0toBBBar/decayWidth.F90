...
#include "looptools.h"
    ...
    double precision A0toBBBarTree, A0toBBBarCT, A0toBBBarReal, treeLevelTemp, realCorrectionsTemp
    double complex A0toBBBarVC, A0toBBBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
    ...
    if (arguments(1) == 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2)) then
                    UVChecks(1) = DBLE(A0toBBBarVC()) + A0toBBBarCT(n)
                else
                    UVChecks(1) = DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                                & A0toBBBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1 and 2 are without tadpoles
                    if ((n == 1) .OR. (n == 2)) then
                        UVChecks(m) = ( DBLE(A0toBBBarVC()) + A0toBBBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                                    & A0toBBBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MA0**4 + MB**4 + MB**4 - 2D0*MA0**2*MB**2 - 2D0*MA0**2*MB**2 &
                        &  - 2D0*MB**2*MB**2 )/(16D0*PI*MA0**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1 and 2 are without tadpoles
                if ((n == 1) .OR. (n == 2)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(A0toBBBarVC()) + &
                                & 2D0*A0toBBBarCT(n) + &
                                & A0toBBBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(A0toBBBarVC() + &
                                & A0toBBBarTad()) + 2D0*A0toBBBarCT(n) + &
                                & A0toBBBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1 and 2 are without tadpoles
                    if ((n == 1) .OR. (n == 2)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(A0toBBBarVC()) + &
                                    & 2D0*A0toBBBarCT(n) + A0toBBBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(A0toBBBarVC() + &
                                    & A0toBBBarTad()) + 2D0*A0toBBBarCT(n) + &
                                    & A0toBBBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", A0toBBBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2)) then
                    call clearcache
                    GaugeXiAChecks(5) = A0toBBBarTree() + &
                        & 2D0*DBLE(A0toBBBarVC()) + A0toBBBarReal() + &
                        & 2D0*A0toBBBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = A0toBBBarTree() + &
                        & 2D0*DBLE(A0toBBBarVC()) + A0toBBBarReal() + &
                        & 2D0*A0toBBBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = A0toBBBarTree() + &
                        & 2D0*DBLE(A0toBBBarVC()) + A0toBBBarReal() + &
                        & 2D0*A0toBBBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = A0toBBBarTree() + &
                        & 2D0*DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                        & A0toBBBarReal() + 2D0*A0toBBBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = A0toBBBarTree() + &
                        & 2D0*DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                        & A0toBBBarReal() + 2D0*A0toBBBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1 and 2 are without tadpoles
                    if ((n == 1) .OR. (n == 2)) then
                        GaugeXiAChecks(m) = ( A0toBBBarTree() + &
                            & 2D0*DBLE(A0toBBBarVC()) + 2D0*A0toBBBarCT(n) + &
                            & A0toBBBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( A0toBBBarTree() + &
                            & 2D0*DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                            & 2D0*A0toBBBarCT(n) + A0toBBBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1 and 2 are without tadpoles
                    if ((n == 1) .OR. (n == 2)) then
                        GaugeXiWChecks(m) = ( A0toBBBarTree() + &
                            & 2D0*DBLE(A0toBBBarVC()) + 2D0*A0toBBBarCT(n) + &
                            & A0toBBBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( A0toBBBarTree() + &
                            & 2D0*DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                            & 2D0*A0toBBBarCT(n) + A0toBBBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1 and 2 are without tadpoles
                    if ((n == 1) .OR. (n == 2)) then
                        GaugeXiZChecks(m) = ( A0toBBBarTree() + &
                            & 2D0*DBLE(A0toBBBarVC()) + 2D0*A0toBBBarCT(n) + &
                            & A0toBBBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( A0toBBBarTree() + &
                            & 2D0*DBLE(A0toBBBarVC() + A0toBBBarTad()) + &
                            & 2D0*A0toBBBarCT(n) + A0toBBBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*A0toBBBarTree()
