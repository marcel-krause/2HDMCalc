    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = A0toDDBarTree() + &
                        & 2D0*DBLE(A0toDDBarVC()) + A0toDDBarReal() + &
                        & 2D0*A0toDDBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = A0toDDBarTree() + &
                        & 2D0*DBLE(A0toDDBarVC()) + A0toDDBarReal() + &
                        & 2D0*A0toDDBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = A0toDDBarTree() + &
                        & 2D0*DBLE(A0toDDBarVC()) + A0toDDBarReal() + &
                        & 2D0*A0toDDBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = A0toDDBarTree() + &
                        & 2D0*DBLE(A0toDDBarVC() + A0toDDBarTad()) + &
                        & A0toDDBarReal() + 2D0*A0toDDBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = A0toDDBarTree() + &
                        & 2D0*DBLE(A0toDDBarVC() + A0toDDBarTad()) + &
                        & A0toDDBarReal() + 2D0*A0toDDBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( A0toDDBarTree() + &
                            & 2D0*DBLE(A0toDDBarVC()) + 2D0*A0toDDBarCT(n) + &
                            & A0toDDBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( A0toDDBarTree() + &
                            & 2D0*DBLE(A0toDDBarVC() + A0toDDBarTad()) + &
                            & 2D0*A0toDDBarCT(n) + A0toDDBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( A0toDDBarTree() + &
                            & 2D0*DBLE(A0toDDBarVC()) + 2D0*A0toDDBarCT(n) + &
                            & A0toDDBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( A0toDDBarTree() + &
                            & 2D0*DBLE(A0toDDBarVC() + A0toDDBarTad()) + &
                            & 2D0*A0toDDBarCT(n) + A0toDDBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( A0toDDBarTree() + &
                            & 2D0*DBLE(A0toDDBarVC()) + 2D0*A0toDDBarCT(n) + &
                            & A0toDDBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( A0toDDBarTree() + &
                            & 2D0*DBLE(A0toDDBarVC() + A0toDDBarTad()) + &
                            & 2D0*A0toDDBarCT(n) + A0toDDBarReal() - &
