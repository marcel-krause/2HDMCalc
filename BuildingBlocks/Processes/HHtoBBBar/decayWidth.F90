...
#include "looptools.h"
    ...
    double precision HHtoBBBarTree, HHtoBBBarCT, HHtoBBBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoBBBarVC, HHtoBBBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoBBBarVC()) + HHtoBBBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                                & HHtoBBBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoBBBarVC()) + HHtoBBBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                                    & HHtoBBBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MB**4 + MB**4 - 2D0*MHH**2*MB**2 - 2D0*MHH**2*MB**2 &
                        &  - 2D0*MB**2*MB**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoBBBarVC()) + &
                                & 2D0*HHtoBBBarCT(n) + &
                                & HHtoBBBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoBBBarVC() + &
                                & HHtoBBBarTad()) + 2D0*HHtoBBBarCT(n) + &
                                & HHtoBBBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoBBBarVC()) + &
                                    & 2D0*HHtoBBBarCT(n) + HHtoBBBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoBBBarVC() + &
                                    & HHtoBBBarTad()) + 2D0*HHtoBBBarCT(n) + &
                                    & HHtoBBBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoBBBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoBBBarTree() + &
                        & 2D0*DBLE(HHtoBBBarVC()) + HHtoBBBarReal() + &
                        & 2D0*HHtoBBBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoBBBarTree() + &
                        & 2D0*DBLE(HHtoBBBarVC()) + HHtoBBBarReal() + &
                        & 2D0*HHtoBBBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoBBBarTree() + &
                        & 2D0*DBLE(HHtoBBBarVC()) + HHtoBBBarReal() + &
                        & 2D0*HHtoBBBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoBBBarTree() + &
                        & 2D0*DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                        & HHtoBBBarReal() + 2D0*HHtoBBBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoBBBarTree() + &
                        & 2D0*DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                        & HHtoBBBarReal() + 2D0*HHtoBBBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoBBBarTree() + &
                            & 2D0*DBLE(HHtoBBBarVC()) + 2D0*HHtoBBBarCT(n) + &
                            & HHtoBBBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoBBBarTree() + &
                            & 2D0*DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                            & 2D0*HHtoBBBarCT(n) + HHtoBBBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoBBBarTree() + &
                            & 2D0*DBLE(HHtoBBBarVC()) + 2D0*HHtoBBBarCT(n) + &
                            & HHtoBBBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoBBBarTree() + &
                            & 2D0*DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                            & 2D0*HHtoBBBarCT(n) + HHtoBBBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoBBBarTree() + &
                            & 2D0*DBLE(HHtoBBBarVC()) + 2D0*HHtoBBBarCT(n) + &
                            & HHtoBBBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoBBBarTree() + &
                            & 2D0*DBLE(HHtoBBBarVC() + HHtoBBBarTad()) + &
                            & 2D0*HHtoBBBarCT(n) + HHtoBBBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoBBBarTree()
