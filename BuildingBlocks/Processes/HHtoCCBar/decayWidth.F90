...
#include "looptools.h"
    ...
    double precision HHtoCCBarTree, HHtoCCBarCT, HHtoCCBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoCCBarVC, HHtoCCBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoCCBarVC()) + HHtoCCBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                                & HHtoCCBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoCCBarVC()) + HHtoCCBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                                    & HHtoCCBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MC**4 + MC**4 - 2D0*MHH**2*MC**2 - 2D0*MHH**2*MC**2 &
                        &  - 2D0*MC**2*MC**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoCCBarVC()) + &
                                & 2D0*HHtoCCBarCT(n) + &
                                & HHtoCCBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoCCBarVC() + &
                                & HHtoCCBarTad()) + 2D0*HHtoCCBarCT(n) + &
                                & HHtoCCBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoCCBarVC()) + &
                                    & 2D0*HHtoCCBarCT(n) + HHtoCCBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoCCBarVC() + &
                                    & HHtoCCBarTad()) + 2D0*HHtoCCBarCT(n) + &
                                    & HHtoCCBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoCCBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoCCBarTree() + &
                        & 2D0*DBLE(HHtoCCBarVC()) + HHtoCCBarReal() + &
                        & 2D0*HHtoCCBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoCCBarTree() + &
                        & 2D0*DBLE(HHtoCCBarVC()) + HHtoCCBarReal() + &
                        & 2D0*HHtoCCBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoCCBarTree() + &
                        & 2D0*DBLE(HHtoCCBarVC()) + HHtoCCBarReal() + &
                        & 2D0*HHtoCCBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoCCBarTree() + &
                        & 2D0*DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                        & HHtoCCBarReal() + 2D0*HHtoCCBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoCCBarTree() + &
                        & 2D0*DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                        & HHtoCCBarReal() + 2D0*HHtoCCBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoCCBarTree() + &
                            & 2D0*DBLE(HHtoCCBarVC()) + 2D0*HHtoCCBarCT(n) + &
                            & HHtoCCBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoCCBarTree() + &
                            & 2D0*DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                            & 2D0*HHtoCCBarCT(n) + HHtoCCBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoCCBarTree() + &
                            & 2D0*DBLE(HHtoCCBarVC()) + 2D0*HHtoCCBarCT(n) + &
                            & HHtoCCBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoCCBarTree() + &
                            & 2D0*DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                            & 2D0*HHtoCCBarCT(n) + HHtoCCBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoCCBarTree() + &
                            & 2D0*DBLE(HHtoCCBarVC()) + 2D0*HHtoCCBarCT(n) + &
                            & HHtoCCBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoCCBarTree() + &
                            & 2D0*DBLE(HHtoCCBarVC() + HHtoCCBarTad()) + &
                            & 2D0*HHtoCCBarCT(n) + HHtoCCBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoCCBarTree()
