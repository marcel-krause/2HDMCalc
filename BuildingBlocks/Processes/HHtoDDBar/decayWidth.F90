...
#include "looptools.h"
    ...
    double precision HHtoDDBarTree, HHtoDDBarCT, HHtoDDBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoDDBarVC, HHtoDDBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoDDBarVC()) + HHtoDDBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                                & HHtoDDBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoDDBarVC()) + HHtoDDBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                                    & HHtoDDBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MD**4 + MD**4 - 2D0*MHH**2*MD**2 - 2D0*MHH**2*MD**2 &
                        &  - 2D0*MD**2*MD**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoDDBarVC()) + &
                                & 2D0*HHtoDDBarCT(n) + &
                                & HHtoDDBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoDDBarVC() + &
                                & HHtoDDBarTad()) + 2D0*HHtoDDBarCT(n) + &
                                & HHtoDDBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoDDBarVC()) + &
                                    & 2D0*HHtoDDBarCT(n) + HHtoDDBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoDDBarVC() + &
                                    & HHtoDDBarTad()) + 2D0*HHtoDDBarCT(n) + &
                                    & HHtoDDBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoDDBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoDDBarTree() + &
                        & 2D0*DBLE(HHtoDDBarVC()) + HHtoDDBarReal() + &
                        & 2D0*HHtoDDBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoDDBarTree() + &
                        & 2D0*DBLE(HHtoDDBarVC()) + HHtoDDBarReal() + &
                        & 2D0*HHtoDDBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoDDBarTree() + &
                        & 2D0*DBLE(HHtoDDBarVC()) + HHtoDDBarReal() + &
                        & 2D0*HHtoDDBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoDDBarTree() + &
                        & 2D0*DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                        & HHtoDDBarReal() + 2D0*HHtoDDBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoDDBarTree() + &
                        & 2D0*DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                        & HHtoDDBarReal() + 2D0*HHtoDDBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoDDBarTree() + &
                            & 2D0*DBLE(HHtoDDBarVC()) + 2D0*HHtoDDBarCT(n) + &
                            & HHtoDDBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoDDBarTree() + &
                            & 2D0*DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                            & 2D0*HHtoDDBarCT(n) + HHtoDDBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoDDBarTree() + &
                            & 2D0*DBLE(HHtoDDBarVC()) + 2D0*HHtoDDBarCT(n) + &
                            & HHtoDDBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoDDBarTree() + &
                            & 2D0*DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                            & 2D0*HHtoDDBarCT(n) + HHtoDDBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoDDBarTree() + &
                            & 2D0*DBLE(HHtoDDBarVC()) + 2D0*HHtoDDBarCT(n) + &
                            & HHtoDDBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoDDBarTree() + &
                            & 2D0*DBLE(HHtoDDBarVC() + HHtoDDBarTad()) + &
                            & 2D0*HHtoDDBarCT(n) + HHtoDDBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoDDBarTree()
