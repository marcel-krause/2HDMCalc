...
#include "looptools.h"
    ...
    double precision HHtoElElBarTree, HHtoElElBarCT, HHtoElElBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoElElBarVC, HHtoElElBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoElElBarVC()) + HHtoElElBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                                & HHtoElElBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoElElBarVC()) + HHtoElElBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                                    & HHtoElElBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + ME**4 + ME**4 - 2D0*MHH**2*ME**2 - 2D0*MHH**2*ME**2 &
                        &  - 2D0*ME**2*ME**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoElElBarVC()) + &
                                & 2D0*HHtoElElBarCT(n) + &
                                & HHtoElElBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoElElBarVC() + &
                                & HHtoElElBarTad()) + 2D0*HHtoElElBarCT(n) + &
                                & HHtoElElBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoElElBarVC()) + &
                                    & 2D0*HHtoElElBarCT(n) + HHtoElElBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoElElBarVC() + &
                                    & HHtoElElBarTad()) + 2D0*HHtoElElBarCT(n) + &
                                    & HHtoElElBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoElElBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoElElBarTree() + &
                        & 2D0*DBLE(HHtoElElBarVC()) + HHtoElElBarReal() + &
                        & 2D0*HHtoElElBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoElElBarTree() + &
                        & 2D0*DBLE(HHtoElElBarVC()) + HHtoElElBarReal() + &
                        & 2D0*HHtoElElBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoElElBarTree() + &
                        & 2D0*DBLE(HHtoElElBarVC()) + HHtoElElBarReal() + &
                        & 2D0*HHtoElElBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoElElBarTree() + &
                        & 2D0*DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                        & HHtoElElBarReal() + 2D0*HHtoElElBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoElElBarTree() + &
                        & 2D0*DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                        & HHtoElElBarReal() + 2D0*HHtoElElBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoElElBarTree() + &
                            & 2D0*DBLE(HHtoElElBarVC()) + 2D0*HHtoElElBarCT(n) + &
                            & HHtoElElBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoElElBarTree() + &
                            & 2D0*DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                            & 2D0*HHtoElElBarCT(n) + HHtoElElBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoElElBarTree() + &
                            & 2D0*DBLE(HHtoElElBarVC()) + 2D0*HHtoElElBarCT(n) + &
                            & HHtoElElBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoElElBarTree() + &
                            & 2D0*DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                            & 2D0*HHtoElElBarCT(n) + HHtoElElBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoElElBarTree() + &
                            & 2D0*DBLE(HHtoElElBarVC()) + 2D0*HHtoElElBarCT(n) + &
                            & HHtoElElBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoElElBarTree() + &
                            & 2D0*DBLE(HHtoElElBarVC() + HHtoElElBarTad()) + &
                            & 2D0*HHtoElElBarCT(n) + HHtoElElBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoElElBarTree()
