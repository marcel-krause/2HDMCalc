...
#include "looptools.h"
    ...
    double precision HHtoHmHpTree, HHtoHmHpCT, HHtoHmHpReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoHmHpVC, HHtoHmHpTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoHmHpVC()) + HHtoHmHpCT(n)
                else
                    UVChecks(1) = DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                                & HHtoHmHpCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoHmHpVC()) + HHtoHmHpCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                                    & HHtoHmHpCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MHp**4 + MHp**4 - 2D0*MHH**2*MHp**2 - 2D0*MHH**2*MHp**2 &
                        &  - 2D0*MHp**2*MHp**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoHmHpVC()) + &
                                & 2D0*HHtoHmHpCT(n) + &
                                & HHtoHmHpReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoHmHpVC() + &
                                & HHtoHmHpTad()) + 2D0*HHtoHmHpCT(n) + &
                                & HHtoHmHpReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoHmHpVC()) + &
                                    & 2D0*HHtoHmHpCT(n) + HHtoHmHpReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoHmHpVC() + &
                                    & HHtoHmHpTad()) + 2D0*HHtoHmHpCT(n) + &
                                    & HHtoHmHpReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoHmHpReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoHmHpTree() + &
                        & 2D0*DBLE(HHtoHmHpVC()) + HHtoHmHpReal() + &
                        & 2D0*HHtoHmHpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoHmHpTree() + &
                        & 2D0*DBLE(HHtoHmHpVC()) + HHtoHmHpReal() + &
                        & 2D0*HHtoHmHpCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoHmHpTree() + &
                        & 2D0*DBLE(HHtoHmHpVC()) + HHtoHmHpReal() + &
                        & 2D0*HHtoHmHpCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoHmHpTree() + &
                        & 2D0*DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                        & HHtoHmHpReal() + 2D0*HHtoHmHpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoHmHpTree() + &
                        & 2D0*DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                        & HHtoHmHpReal() + 2D0*HHtoHmHpCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoHmHpTree() + &
                            & 2D0*DBLE(HHtoHmHpVC()) + 2D0*HHtoHmHpCT(n) + &
                            & HHtoHmHpReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoHmHpTree() + &
                            & 2D0*DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                            & 2D0*HHtoHmHpCT(n) + HHtoHmHpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoHmHpTree() + &
                            & 2D0*DBLE(HHtoHmHpVC()) + 2D0*HHtoHmHpCT(n) + &
                            & HHtoHmHpReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoHmHpTree() + &
                            & 2D0*DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                            & 2D0*HHtoHmHpCT(n) + HHtoHmHpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoHmHpTree() + &
                            & 2D0*DBLE(HHtoHmHpVC()) + 2D0*HHtoHmHpCT(n) + &
                            & HHtoHmHpReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoHmHpTree() + &
                            & 2D0*DBLE(HHtoHmHpVC() + HHtoHmHpTad()) + &
                            & 2D0*HHtoHmHpCT(n) + HHtoHmHpReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoHmHpTree()
