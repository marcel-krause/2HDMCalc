...
#include "looptools.h"
    ...
    double precision HHtoHpWmTree, HHtoHpWmCT, HHtoHpWmReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoHpWmVC, HHtoHpWmTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoHpWmVC()) + HHtoHpWmCT(n)
                else
                    UVChecks(1) = DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                                & HHtoHpWmCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoHpWmVC()) + HHtoHpWmCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                                    & HHtoHpWmCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MHp**4 + MW**4 - 2D0*MHH**2*MHp**2 - 2D0*MHH**2*MW**2 &
                        &  - 2D0*MHp**2*MW**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoHpWmVC()) + &
                                & 2D0*HHtoHpWmCT(n) + &
                                & HHtoHpWmReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoHpWmVC() + &
                                & HHtoHpWmTad()) + 2D0*HHtoHpWmCT(n) + &
                                & HHtoHpWmReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoHpWmVC()) + &
                                    & 2D0*HHtoHpWmCT(n) + HHtoHpWmReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoHpWmVC() + &
                                    & HHtoHpWmTad()) + 2D0*HHtoHpWmCT(n) + &
                                    & HHtoHpWmReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoHpWmReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoHpWmTree() + &
                        & 2D0*DBLE(HHtoHpWmVC()) + HHtoHpWmReal() + &
                        & 2D0*HHtoHpWmCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoHpWmTree() + &
                        & 2D0*DBLE(HHtoHpWmVC()) + HHtoHpWmReal() + &
                        & 2D0*HHtoHpWmCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoHpWmTree() + &
                        & 2D0*DBLE(HHtoHpWmVC()) + HHtoHpWmReal() + &
                        & 2D0*HHtoHpWmCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoHpWmTree() + &
                        & 2D0*DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                        & HHtoHpWmReal() + 2D0*HHtoHpWmCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoHpWmTree() + &
                        & 2D0*DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                        & HHtoHpWmReal() + 2D0*HHtoHpWmCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoHpWmTree() + &
                            & 2D0*DBLE(HHtoHpWmVC()) + 2D0*HHtoHpWmCT(n) + &
                            & HHtoHpWmReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoHpWmTree() + &
                            & 2D0*DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                            & 2D0*HHtoHpWmCT(n) + HHtoHpWmReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoHpWmTree() + &
                            & 2D0*DBLE(HHtoHpWmVC()) + 2D0*HHtoHpWmCT(n) + &
                            & HHtoHpWmReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoHpWmTree() + &
                            & 2D0*DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                            & 2D0*HHtoHpWmCT(n) + HHtoHpWmReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoHpWmTree() + &
                            & 2D0*DBLE(HHtoHpWmVC()) + 2D0*HHtoHpWmCT(n) + &
                            & HHtoHpWmReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoHpWmTree() + &
                            & 2D0*DBLE(HHtoHpWmVC() + HHtoHpWmTad()) + &
                            & 2D0*HHtoHpWmCT(n) + HHtoHpWmReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoHpWmTree()
