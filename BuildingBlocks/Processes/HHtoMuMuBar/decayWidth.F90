...
#include "looptools.h"
    ...
    double precision HHtoMuMuBarTree, HHtoMuMuBarCT, HHtoMuMuBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoMuMuBarVC, HHtoMuMuBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoMuMuBarVC()) + HHtoMuMuBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                                & HHtoMuMuBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoMuMuBarVC()) + HHtoMuMuBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                                    & HHtoMuMuBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MM**4 + MM**4 - 2D0*MHH**2*MM**2 - 2D0*MHH**2*MM**2 &
                        &  - 2D0*MM**2*MM**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoMuMuBarVC()) + &
                                & 2D0*HHtoMuMuBarCT(n) + &
                                & HHtoMuMuBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoMuMuBarVC() + &
                                & HHtoMuMuBarTad()) + 2D0*HHtoMuMuBarCT(n) + &
                                & HHtoMuMuBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoMuMuBarVC()) + &
                                    & 2D0*HHtoMuMuBarCT(n) + HHtoMuMuBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoMuMuBarVC() + &
                                    & HHtoMuMuBarTad()) + 2D0*HHtoMuMuBarCT(n) + &
                                    & HHtoMuMuBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoMuMuBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoMuMuBarTree() + &
                        & 2D0*DBLE(HHtoMuMuBarVC()) + HHtoMuMuBarReal() + &
                        & 2D0*HHtoMuMuBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoMuMuBarTree() + &
                        & 2D0*DBLE(HHtoMuMuBarVC()) + HHtoMuMuBarReal() + &
                        & 2D0*HHtoMuMuBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoMuMuBarTree() + &
                        & 2D0*DBLE(HHtoMuMuBarVC()) + HHtoMuMuBarReal() + &
                        & 2D0*HHtoMuMuBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoMuMuBarTree() + &
                        & 2D0*DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                        & HHtoMuMuBarReal() + 2D0*HHtoMuMuBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoMuMuBarTree() + &
                        & 2D0*DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                        & HHtoMuMuBarReal() + 2D0*HHtoMuMuBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoMuMuBarTree() + &
                            & 2D0*DBLE(HHtoMuMuBarVC()) + 2D0*HHtoMuMuBarCT(n) + &
                            & HHtoMuMuBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoMuMuBarTree() + &
                            & 2D0*DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                            & 2D0*HHtoMuMuBarCT(n) + HHtoMuMuBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoMuMuBarTree() + &
                            & 2D0*DBLE(HHtoMuMuBarVC()) + 2D0*HHtoMuMuBarCT(n) + &
                            & HHtoMuMuBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoMuMuBarTree() + &
                            & 2D0*DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                            & 2D0*HHtoMuMuBarCT(n) + HHtoMuMuBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoMuMuBarTree() + &
                            & 2D0*DBLE(HHtoMuMuBarVC()) + 2D0*HHtoMuMuBarCT(n) + &
                            & HHtoMuMuBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoMuMuBarTree() + &
                            & 2D0*DBLE(HHtoMuMuBarVC() + HHtoMuMuBarTad()) + &
                            & 2D0*HHtoMuMuBarCT(n) + HHtoMuMuBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoMuMuBarTree()
