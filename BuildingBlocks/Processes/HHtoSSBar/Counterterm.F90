double precision function HHtoSSBarCT(x)
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 select case (x)
	case (1)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSUsual()/MS - dMW2Usual()/(2D0*MW2) - dBeta1KanUsual()/TB + &
			& dAlphaKanUsual()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSUsual()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (2)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSUsual()/MS - dMW2Usual()/(2D0*MW2) - dBeta2KanUsual()/TB + &
			& dAlphaKanUsual()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSUsual()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (3)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSAlter()/MS - dMW2Alter()/(2D0*MW2) - dBeta1KanAlter()/TB + &
			& dAlphaKanAlter()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSAlter()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)	
	case (4)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSAlter()/MS - dMW2Alter()/(2D0*MW2) - dBeta2KanAlter()/TB + &
			& dAlphaKanAlter()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSAlter()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (5)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSAlter()/MS - dMW2Alter()/(2D0*MW2) - dBeta1PinchPStar()/TB + &
			& dAlphaPinchPStar()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSAlter()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (6)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSAlter()/MS - dMW2Alter()/(2D0*MW2) - dBeta2PinchPStar()/TB + &
			& dAlphaPinchPStar()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSAlter()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (7)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSAlter()/MS - dMW2Alter()/(2D0*MW2) - dBeta1PinchOS()/TB + &
			& dAlphaPinchOS()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSAlter()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (8)
		totalAmplitude = ( dgAtMZ()/(EL/SW) + dMSOSAlter()/MS - dMW2Alter()/(2D0*MW2) - dBeta2PinchOS()/TB + &
			& dAlphaPinchOS()/TA + dZHHHHOS()/2D0 + CA/SA * dZh0HHOSAlter()/2D0 + dZSSOSLeft()/2D0 + &
			& dZSSOSRight()/2D0 )*(1.5D0*EL2*(MHH2 - 4.D0*MS2)*MS2*DBLE(Yuk2**INT(2.D0)))/(MW2*SW2)
	case (9)
 ...
 HHtoSSBarCT = totalAmplitude
end function HHtoSSBarCT
