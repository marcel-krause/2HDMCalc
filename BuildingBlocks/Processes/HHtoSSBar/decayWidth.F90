...
#include "looptools.h"
    ...
    double precision HHtoSSBarTree, HHtoSSBarCT, HHtoSSBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoSSBarVC, HHtoSSBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoSSBarVC()) + HHtoSSBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                                & HHtoSSBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoSSBarVC()) + HHtoSSBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                                    & HHtoSSBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MS**4 + MS**4 - 2D0*MHH**2*MS**2 - 2D0*MHH**2*MS**2 &
                        &  - 2D0*MS**2*MS**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoSSBarVC()) + &
                                & 2D0*HHtoSSBarCT(n) + &
                                & HHtoSSBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoSSBarVC() + &
                                & HHtoSSBarTad()) + 2D0*HHtoSSBarCT(n) + &
                                & HHtoSSBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoSSBarVC()) + &
                                    & 2D0*HHtoSSBarCT(n) + HHtoSSBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoSSBarVC() + &
                                    & HHtoSSBarTad()) + 2D0*HHtoSSBarCT(n) + &
                                    & HHtoSSBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoSSBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoSSBarTree() + &
                        & 2D0*DBLE(HHtoSSBarVC()) + HHtoSSBarReal() + &
                        & 2D0*HHtoSSBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoSSBarTree() + &
                        & 2D0*DBLE(HHtoSSBarVC()) + HHtoSSBarReal() + &
                        & 2D0*HHtoSSBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoSSBarTree() + &
                        & 2D0*DBLE(HHtoSSBarVC()) + HHtoSSBarReal() + &
                        & 2D0*HHtoSSBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoSSBarTree() + &
                        & 2D0*DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                        & HHtoSSBarReal() + 2D0*HHtoSSBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoSSBarTree() + &
                        & 2D0*DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                        & HHtoSSBarReal() + 2D0*HHtoSSBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoSSBarTree() + &
                            & 2D0*DBLE(HHtoSSBarVC()) + 2D0*HHtoSSBarCT(n) + &
                            & HHtoSSBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoSSBarTree() + &
                            & 2D0*DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                            & 2D0*HHtoSSBarCT(n) + HHtoSSBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoSSBarTree() + &
                            & 2D0*DBLE(HHtoSSBarVC()) + 2D0*HHtoSSBarCT(n) + &
                            & HHtoSSBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoSSBarTree() + &
                            & 2D0*DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                            & 2D0*HHtoSSBarCT(n) + HHtoSSBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoSSBarTree() + &
                            & 2D0*DBLE(HHtoSSBarVC()) + 2D0*HHtoSSBarCT(n) + &
                            & HHtoSSBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoSSBarTree() + &
                            & 2D0*DBLE(HHtoSSBarVC() + HHtoSSBarTad()) + &
                            & 2D0*HHtoSSBarCT(n) + HHtoSSBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoSSBarTree()
