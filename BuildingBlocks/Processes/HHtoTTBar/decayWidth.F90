...
#include "looptools.h"
    ...
    double precision HHtoTTBarTree, HHtoTTBarCT, HHtoTTBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoTTBarVC, HHtoTTBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoTTBarVC()) + HHtoTTBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                                & HHtoTTBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoTTBarVC()) + HHtoTTBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                                    & HHtoTTBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MT**4 + MT**4 - 2D0*MHH**2*MT**2 - 2D0*MHH**2*MT**2 &
                        &  - 2D0*MT**2*MT**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoTTBarVC()) + &
                                & 2D0*HHtoTTBarCT(n) + &
                                & HHtoTTBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoTTBarVC() + &
                                & HHtoTTBarTad()) + 2D0*HHtoTTBarCT(n) + &
                                & HHtoTTBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoTTBarVC()) + &
                                    & 2D0*HHtoTTBarCT(n) + HHtoTTBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoTTBarVC() + &
                                    & HHtoTTBarTad()) + 2D0*HHtoTTBarCT(n) + &
                                    & HHtoTTBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoTTBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoTTBarTree() + &
                        & 2D0*DBLE(HHtoTTBarVC()) + HHtoTTBarReal() + &
                        & 2D0*HHtoTTBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoTTBarTree() + &
                        & 2D0*DBLE(HHtoTTBarVC()) + HHtoTTBarReal() + &
                        & 2D0*HHtoTTBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoTTBarTree() + &
                        & 2D0*DBLE(HHtoTTBarVC()) + HHtoTTBarReal() + &
                        & 2D0*HHtoTTBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoTTBarTree() + &
                        & 2D0*DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                        & HHtoTTBarReal() + 2D0*HHtoTTBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoTTBarTree() + &
                        & 2D0*DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                        & HHtoTTBarReal() + 2D0*HHtoTTBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoTTBarTree() + &
                            & 2D0*DBLE(HHtoTTBarVC()) + 2D0*HHtoTTBarCT(n) + &
                            & HHtoTTBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoTTBarTree() + &
                            & 2D0*DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                            & 2D0*HHtoTTBarCT(n) + HHtoTTBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoTTBarTree() + &
                            & 2D0*DBLE(HHtoTTBarVC()) + 2D0*HHtoTTBarCT(n) + &
                            & HHtoTTBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoTTBarTree() + &
                            & 2D0*DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                            & 2D0*HHtoTTBarCT(n) + HHtoTTBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoTTBarTree() + &
                            & 2D0*DBLE(HHtoTTBarVC()) + 2D0*HHtoTTBarCT(n) + &
                            & HHtoTTBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoTTBarTree() + &
                            & 2D0*DBLE(HHtoTTBarVC() + HHtoTTBarTad()) + &
                            & 2D0*HHtoTTBarCT(n) + HHtoTTBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoTTBarTree()
