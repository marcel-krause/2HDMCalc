...
#include "looptools.h"
    ...
    double precision HHtoTauTauBarTree, HHtoTauTauBarCT, HHtoTauTauBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoTauTauBarVC, HHtoTauTauBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoTauTauBarVC()) + HHtoTauTauBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                                & HHtoTauTauBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoTauTauBarVC()) + HHtoTauTauBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                                    & HHtoTauTauBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + ML**4 + ML**4 - 2D0*MHH**2*ML**2 - 2D0*MHH**2*ML**2 &
                        &  - 2D0*ML**2*ML**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoTauTauBarVC()) + &
                                & 2D0*HHtoTauTauBarCT(n) + &
                                & HHtoTauTauBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoTauTauBarVC() + &
                                & HHtoTauTauBarTad()) + 2D0*HHtoTauTauBarCT(n) + &
                                & HHtoTauTauBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoTauTauBarVC()) + &
                                    & 2D0*HHtoTauTauBarCT(n) + HHtoTauTauBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoTauTauBarVC() + &
                                    & HHtoTauTauBarTad()) + 2D0*HHtoTauTauBarCT(n) + &
                                    & HHtoTauTauBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoTauTauBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoTauTauBarTree() + &
                        & 2D0*DBLE(HHtoTauTauBarVC()) + HHtoTauTauBarReal() + &
                        & 2D0*HHtoTauTauBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoTauTauBarTree() + &
                        & 2D0*DBLE(HHtoTauTauBarVC()) + HHtoTauTauBarReal() + &
                        & 2D0*HHtoTauTauBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoTauTauBarTree() + &
                        & 2D0*DBLE(HHtoTauTauBarVC()) + HHtoTauTauBarReal() + &
                        & 2D0*HHtoTauTauBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoTauTauBarTree() + &
                        & 2D0*DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                        & HHtoTauTauBarReal() + 2D0*HHtoTauTauBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoTauTauBarTree() + &
                        & 2D0*DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                        & HHtoTauTauBarReal() + 2D0*HHtoTauTauBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoTauTauBarTree() + &
                            & 2D0*DBLE(HHtoTauTauBarVC()) + 2D0*HHtoTauTauBarCT(n) + &
                            & HHtoTauTauBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoTauTauBarTree() + &
                            & 2D0*DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                            & 2D0*HHtoTauTauBarCT(n) + HHtoTauTauBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoTauTauBarTree() + &
                            & 2D0*DBLE(HHtoTauTauBarVC()) + 2D0*HHtoTauTauBarCT(n) + &
                            & HHtoTauTauBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoTauTauBarTree() + &
                            & 2D0*DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                            & 2D0*HHtoTauTauBarCT(n) + HHtoTauTauBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoTauTauBarTree() + &
                            & 2D0*DBLE(HHtoTauTauBarVC()) + 2D0*HHtoTauTauBarCT(n) + &
                            & HHtoTauTauBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoTauTauBarTree() + &
                            & 2D0*DBLE(HHtoTauTauBarVC() + HHtoTauTauBarTad()) + &
                            & 2D0*HHtoTauTauBarCT(n) + HHtoTauTauBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoTauTauBarTree()
