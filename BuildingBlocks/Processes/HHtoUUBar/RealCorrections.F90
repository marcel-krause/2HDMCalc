double precision function HHtoUUBarReal()
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 totalAmplitude = 3D0*EL2*m2**2*SA2/(4D0*MW2*SW2*SB2)*(EL2/(2D0*(4D0*PI)**3*m1))*&
     &(16D0*PI*m1**3)/DSQRT(m1**4 + m2**4 + m3**4 - 2D0*m1**2*m2**2 - 2D0*m1**2*m3**2 - 2D0*m2**2*m3**2 )*&
     &( 2D0*( OLLFull ) + 2D0*( OLRFull ) )

 HHtoUUBarReal = totalAmplitude
end function HHtoUUBarReal
