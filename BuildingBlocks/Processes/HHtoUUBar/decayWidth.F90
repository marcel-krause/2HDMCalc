...
#include "looptools.h"
    ...
    double precision HHtoUUBarTree, HHtoUUBarCT, HHtoUUBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoUUBarVC, HHtoUUBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoUUBarVC()) + HHtoUUBarCT(n)
                else
                    UVChecks(1) = DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                                & HHtoUUBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoUUBarVC()) + HHtoUUBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                                    & HHtoUUBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MU**4 + MU**4 - 2D0*MHH**2*MU**2 - 2D0*MHH**2*MU**2 &
                        &  - 2D0*MU**2*MU**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoUUBarVC()) + &
                                & 2D0*HHtoUUBarCT(n) + &
                                & HHtoUUBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoUUBarVC() + &
                                & HHtoUUBarTad()) + 2D0*HHtoUUBarCT(n) + &
                                & HHtoUUBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoUUBarVC()) + &
                                    & 2D0*HHtoUUBarCT(n) + HHtoUUBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoUUBarVC() + &
                                    & HHtoUUBarTad()) + 2D0*HHtoUUBarCT(n) + &
                                    & HHtoUUBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoUUBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoUUBarTree() + &
                        & 2D0*DBLE(HHtoUUBarVC()) + HHtoUUBarReal() + &
                        & 2D0*HHtoUUBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoUUBarTree() + &
                        & 2D0*DBLE(HHtoUUBarVC()) + HHtoUUBarReal() + &
                        & 2D0*HHtoUUBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoUUBarTree() + &
                        & 2D0*DBLE(HHtoUUBarVC()) + HHtoUUBarReal() + &
                        & 2D0*HHtoUUBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoUUBarTree() + &
                        & 2D0*DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                        & HHtoUUBarReal() + 2D0*HHtoUUBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoUUBarTree() + &
                        & 2D0*DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                        & HHtoUUBarReal() + 2D0*HHtoUUBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoUUBarTree() + &
                            & 2D0*DBLE(HHtoUUBarVC()) + 2D0*HHtoUUBarCT(n) + &
                            & HHtoUUBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoUUBarTree() + &
                            & 2D0*DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                            & 2D0*HHtoUUBarCT(n) + HHtoUUBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoUUBarTree() + &
                            & 2D0*DBLE(HHtoUUBarVC()) + 2D0*HHtoUUBarCT(n) + &
                            & HHtoUUBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoUUBarTree() + &
                            & 2D0*DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                            & 2D0*HHtoUUBarCT(n) + HHtoUUBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoUUBarTree() + &
                            & 2D0*DBLE(HHtoUUBarVC()) + 2D0*HHtoUUBarCT(n) + &
                            & HHtoUUBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoUUBarTree() + &
                            & 2D0*DBLE(HHtoUUBarVC() + HHtoUUBarTad()) + &
                            & 2D0*HHtoUUBarCT(n) + HHtoUUBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoUUBarTree()
