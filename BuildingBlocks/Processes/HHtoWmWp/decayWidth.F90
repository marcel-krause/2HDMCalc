...
#include "looptools.h"
    ...
    double precision HHtoWmWpTree, HHtoWmWpCT, HHtoWmWpReal, treeLevelTemp, realCorrectionsTemp
    double complex HHtoWmWpVC, HHtoWmWpTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoWmWpVC()) + HHtoWmWpCT(n)
                else
                    UVChecks(1) = DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                                & HHtoWmWpCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoWmWpVC()) + HHtoWmWpCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                                    & HHtoWmWpCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHH**4 + MW**4 + MW**4 - 2D0*MHH**2*MW**2 - 2D0*MHH**2*MW**2 &
                        &  - 2D0*MW**2*MW**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoWmWpVC()) + &
                                & 2D0*HHtoWmWpCT(n) + &
                                & HHtoWmWpReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoWmWpVC() + &
                                & HHtoWmWpTad()) + 2D0*HHtoWmWpCT(n) + &
                                & HHtoWmWpReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoWmWpVC()) + &
                                    & 2D0*HHtoWmWpCT(n) + HHtoWmWpReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoWmWpVC() + &
                                    & HHtoWmWpTad()) + 2D0*HHtoWmWpCT(n) + &
                                    & HHtoWmWpReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoWmWpReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoWmWpTree() + &
                        & 2D0*DBLE(HHtoWmWpVC()) + HHtoWmWpReal() + &
                        & 2D0*HHtoWmWpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoWmWpTree() + &
                        & 2D0*DBLE(HHtoWmWpVC()) + HHtoWmWpReal() + &
                        & 2D0*HHtoWmWpCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoWmWpTree() + &
                        & 2D0*DBLE(HHtoWmWpVC()) + HHtoWmWpReal() + &
                        & 2D0*HHtoWmWpCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoWmWpTree() + &
                        & 2D0*DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                        & HHtoWmWpReal() + 2D0*HHtoWmWpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoWmWpTree() + &
                        & 2D0*DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                        & HHtoWmWpReal() + 2D0*HHtoWmWpCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoWmWpTree() + &
                            & 2D0*DBLE(HHtoWmWpVC()) + 2D0*HHtoWmWpCT(n) + &
                            & HHtoWmWpReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoWmWpTree() + &
                            & 2D0*DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                            & 2D0*HHtoWmWpCT(n) + HHtoWmWpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoWmWpTree() + &
                            & 2D0*DBLE(HHtoWmWpVC()) + 2D0*HHtoWmWpCT(n) + &
                            & HHtoWmWpReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoWmWpTree() + &
                            & 2D0*DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                            & 2D0*HHtoWmWpCT(n) + HHtoWmWpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoWmWpTree() + &
                            & 2D0*DBLE(HHtoWmWpVC()) + 2D0*HHtoWmWpCT(n) + &
                            & HHtoWmWpReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoWmWpTree() + &
                            & 2D0*DBLE(HHtoWmWpVC() + HHtoWmWpTad()) + &
                            & 2D0*HHtoWmWpCT(n) + HHtoWmWpReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoWmWpTree()
