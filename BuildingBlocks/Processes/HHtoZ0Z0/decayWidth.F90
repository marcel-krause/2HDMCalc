...
#include "looptools.h"
    ...
    double precision HHtoZ0Z0Tree, HHtoZ0Z0CT, HHtoZ0Z0Real, treeLevelTemp, realCorrectionsTemp
    double complex HHtoZ0Z0VC, HHtoZ0Z0Tad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HHtoZ0Z0VC()) + HHtoZ0Z0CT(n)
                else
                    UVChecks(1) = DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                                & HHtoZ0Z0CT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HHtoZ0Z0VC()) + HHtoZ0Z0CT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                                    & HHtoZ0Z0CT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/2D0 * DSQRT(MHH**4 + MZ**4 + MZ**4 - 2D0*MHH**2*MZ**2 - 2D0*MHH**2*MZ**2 &
                        &  - 2D0*MZ**2*MZ**2 )/(16D0*PI*MHH**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoZ0Z0VC()) + &
                                & 2D0*HHtoZ0Z0CT(n) + &
                                & HHtoZ0Z0Real() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HHtoZ0Z0VC() + &
                                & HHtoZ0Z0Tad()) + 2D0*HHtoZ0Z0CT(n) + &
                                & HHtoZ0Z0Real() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoZ0Z0VC()) + &
                                    & 2D0*HHtoZ0Z0CT(n) + HHtoZ0Z0Real() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HHtoZ0Z0VC() + &
                                    & HHtoZ0Z0Tad()) + 2D0*HHtoZ0Z0CT(n) + &
                                    & HHtoZ0Z0Real() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HHtoZ0Z0Real()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HHtoZ0Z0Tree() + &
                        & 2D0*DBLE(HHtoZ0Z0VC()) + HHtoZ0Z0Real() + &
                        & 2D0*HHtoZ0Z0CT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoZ0Z0Tree() + &
                        & 2D0*DBLE(HHtoZ0Z0VC()) + HHtoZ0Z0Real() + &
                        & 2D0*HHtoZ0Z0CT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HHtoZ0Z0Tree() + &
                        & 2D0*DBLE(HHtoZ0Z0VC()) + HHtoZ0Z0Real() + &
                        & 2D0*HHtoZ0Z0CT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HHtoZ0Z0Tree() + &
                        & 2D0*DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                        & HHtoZ0Z0Real() + 2D0*HHtoZ0Z0CT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HHtoZ0Z0Tree() + &
                        & 2D0*DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                        & HHtoZ0Z0Real() + 2D0*HHtoZ0Z0CT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HHtoZ0Z0Tree() + &
                            & 2D0*DBLE(HHtoZ0Z0VC()) + 2D0*HHtoZ0Z0CT(n) + &
                            & HHtoZ0Z0Real() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HHtoZ0Z0Tree() + &
                            & 2D0*DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                            & 2D0*HHtoZ0Z0CT(n) + HHtoZ0Z0Real() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HHtoZ0Z0Tree() + &
                            & 2D0*DBLE(HHtoZ0Z0VC()) + 2D0*HHtoZ0Z0CT(n) + &
                            & HHtoZ0Z0Real() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HHtoZ0Z0Tree() + &
                            & 2D0*DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                            & 2D0*HHtoZ0Z0CT(n) + HHtoZ0Z0Real() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HHtoZ0Z0Tree() + &
                            & 2D0*DBLE(HHtoZ0Z0VC()) + 2D0*HHtoZ0Z0CT(n) + &
                            & HHtoZ0Z0Real() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HHtoZ0Z0Tree() + &
                            & 2D0*DBLE(HHtoZ0Z0VC() + HHtoZ0Z0Tad()) + &
                            & 2D0*HHtoZ0Z0CT(n) + HHtoZ0Z0Real() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HHtoZ0Z0Tree()
