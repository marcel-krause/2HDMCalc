...
#include "looptools.h"
    ...
    double precision HptoA0WpTree, HptoA0WpCT, HptoA0WpReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoA0WpVC, HptoA0WpTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoA0WpVC()) + HptoA0WpCT(n)
                else
                    UVChecks(1) = DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                                & HptoA0WpCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoA0WpVC()) + HptoA0WpCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                                    & HptoA0WpCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MA0**4 + MW**4 - 2D0*MHp**2*MA0**2 - 2D0*MHp**2*MW**2 &
                        &  - 2D0*MA0**2*MW**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoA0WpVC()) + &
                                & 2D0*HptoA0WpCT(n) + &
                                & HptoA0WpReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoA0WpVC() + &
                                & HptoA0WpTad()) + 2D0*HptoA0WpCT(n) + &
                                & HptoA0WpReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoA0WpVC()) + &
                                    & 2D0*HptoA0WpCT(n) + HptoA0WpReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoA0WpVC() + &
                                    & HptoA0WpTad()) + 2D0*HptoA0WpCT(n) + &
                                    & HptoA0WpReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoA0WpReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoA0WpTree() + &
                        & 2D0*DBLE(HptoA0WpVC()) + HptoA0WpReal() + &
                        & 2D0*HptoA0WpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoA0WpTree() + &
                        & 2D0*DBLE(HptoA0WpVC()) + HptoA0WpReal() + &
                        & 2D0*HptoA0WpCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoA0WpTree() + &
                        & 2D0*DBLE(HptoA0WpVC()) + HptoA0WpReal() + &
                        & 2D0*HptoA0WpCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoA0WpTree() + &
                        & 2D0*DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                        & HptoA0WpReal() + 2D0*HptoA0WpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoA0WpTree() + &
                        & 2D0*DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                        & HptoA0WpReal() + 2D0*HptoA0WpCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoA0WpTree() + &
                            & 2D0*DBLE(HptoA0WpVC()) + 2D0*HptoA0WpCT(n) + &
                            & HptoA0WpReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoA0WpTree() + &
                            & 2D0*DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                            & 2D0*HptoA0WpCT(n) + HptoA0WpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoA0WpTree() + &
                            & 2D0*DBLE(HptoA0WpVC()) + 2D0*HptoA0WpCT(n) + &
                            & HptoA0WpReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoA0WpTree() + &
                            & 2D0*DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                            & 2D0*HptoA0WpCT(n) + HptoA0WpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoA0WpTree() + &
                            & 2D0*DBLE(HptoA0WpVC()) + 2D0*HptoA0WpCT(n) + &
                            & HptoA0WpReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoA0WpTree() + &
                            & 2D0*DBLE(HptoA0WpVC() + HptoA0WpTad()) + &
                            & 2D0*HptoA0WpCT(n) + HptoA0WpReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoA0WpTree()
