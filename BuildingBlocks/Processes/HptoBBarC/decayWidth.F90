...
#include "looptools.h"
    ...
    double precision HptoBBarCTree, HptoBBarCCT, HptoBBarCReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoBBarCVC, HptoBBarCTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoBBarCVC()) + HptoBBarCCT(n)
                else
                    UVChecks(1) = DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                                & HptoBBarCCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoBBarCVC()) + HptoBBarCCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                                    & HptoBBarCCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
                    print *, "Delta: ", getdelta(), ", Difference from Delta=0: ", UVChecks(m)
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MB**4 + MC**4 - 2D0*MHp**2*MB**2 - 2D0*MHp**2*MC**2 &
                        &  - 2D0*MB**2*MC**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoBBarCVC()) + &
                                & 2D0*HptoBBarCCT(n) + &
                                & HptoBBarCReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoBBarCVC() + &
                                & HptoBBarCTad()) + 2D0*HptoBBarCCT(n) + &
                                & HptoBBarCReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoBBarCVC()) + &
                                    & 2D0*HptoBBarCCT(n) + HptoBBarCReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoBBarCVC() + &
                                    & HptoBBarCTad()) + 2D0*HptoBBarCCT(n) + &
                                    & HptoBBarCReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoBBarCReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoBBarCTree() + &
                        & 2D0*DBLE(HptoBBarCVC()) + HptoBBarCReal() + &
                        & 2D0*HptoBBarCCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoBBarCTree() + &
                        & 2D0*DBLE(HptoBBarCVC()) + HptoBBarCReal() + &
                        & 2D0*HptoBBarCCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoBBarCTree() + &
                        & 2D0*DBLE(HptoBBarCVC()) + HptoBBarCReal() + &
                        & 2D0*HptoBBarCCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoBBarCTree() + &
                        & 2D0*DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                        & HptoBBarCReal() + 2D0*HptoBBarCCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoBBarCTree() + &
                        & 2D0*DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                        & HptoBBarCReal() + 2D0*HptoBBarCCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoBBarCTree() + &
                            & 2D0*DBLE(HptoBBarCVC()) + 2D0*HptoBBarCCT(n) + &
                            & HptoBBarCReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoBBarCTree() + &
                            & 2D0*DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                            & 2D0*HptoBBarCCT(n) + HptoBBarCReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoBBarCTree() + &
                            & 2D0*DBLE(HptoBBarCVC()) + 2D0*HptoBBarCCT(n) + &
                            & HptoBBarCReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoBBarCTree() + &
                            & 2D0*DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                            & 2D0*HptoBBarCCT(n) + HptoBBarCReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoBBarCTree() + &
                            & 2D0*DBLE(HptoBBarCVC()) + 2D0*HptoBBarCCT(n) + &
                            & HptoBBarCReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoBBarCTree() + &
                            & 2D0*DBLE(HptoBBarCVC() + HptoBBarCTad()) + &
                            & 2D0*HptoBBarCCT(n) + HptoBBarCReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoBBarCTree()
