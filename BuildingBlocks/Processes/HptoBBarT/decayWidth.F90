...
#include "looptools.h"
    ...
    double precision HptoBBarTTree, HptoBBarTCT, HptoBBarTReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoBBarTVC, HptoBBarTTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoBBarTVC()) + HptoBBarTCT(n)
                else
                    UVChecks(1) = DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                                & HptoBBarTCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoBBarTVC()) + HptoBBarTCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                                    & HptoBBarTCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MB**4 + MT**4 - 2D0*MHp**2*MB**2 - 2D0*MHp**2*MT**2 &
                        &  - 2D0*MB**2*MT**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoBBarTVC()) + &
                                & 2D0*HptoBBarTCT(n) + &
                                & HptoBBarTReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoBBarTVC() + &
                                & HptoBBarTTad()) + 2D0*HptoBBarTCT(n) + &
                                & HptoBBarTReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoBBarTVC()) + &
                                    & 2D0*HptoBBarTCT(n) + HptoBBarTReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoBBarTVC() + &
                                    & HptoBBarTTad()) + 2D0*HptoBBarTCT(n) + &
                                    & HptoBBarTReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoBBarTReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoBBarTTree() + &
                        & 2D0*DBLE(HptoBBarTVC()) + HptoBBarTReal() + &
                        & 2D0*HptoBBarTCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoBBarTTree() + &
                        & 2D0*DBLE(HptoBBarTVC()) + HptoBBarTReal() + &
                        & 2D0*HptoBBarTCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoBBarTTree() + &
                        & 2D0*DBLE(HptoBBarTVC()) + HptoBBarTReal() + &
                        & 2D0*HptoBBarTCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoBBarTTree() + &
                        & 2D0*DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                        & HptoBBarTReal() + 2D0*HptoBBarTCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoBBarTTree() + &
                        & 2D0*DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                        & HptoBBarTReal() + 2D0*HptoBBarTCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoBBarTTree() + &
                            & 2D0*DBLE(HptoBBarTVC()) + 2D0*HptoBBarTCT(n) + &
                            & HptoBBarTReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoBBarTTree() + &
                            & 2D0*DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                            & 2D0*HptoBBarTCT(n) + HptoBBarTReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoBBarTTree() + &
                            & 2D0*DBLE(HptoBBarTVC()) + 2D0*HptoBBarTCT(n) + &
                            & HptoBBarTReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoBBarTTree() + &
                            & 2D0*DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                            & 2D0*HptoBBarTCT(n) + HptoBBarTReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoBBarTTree() + &
                            & 2D0*DBLE(HptoBBarTVC()) + 2D0*HptoBBarTCT(n) + &
                            & HptoBBarTReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoBBarTTree() + &
                            & 2D0*DBLE(HptoBBarTVC() + HptoBBarTTad()) + &
                            & 2D0*HptoBBarTCT(n) + HptoBBarTReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoBBarTTree()
