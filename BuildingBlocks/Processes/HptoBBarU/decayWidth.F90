...
#include "looptools.h"
    ...
    double precision HptoBBarUTree, HptoBBarUCT, HptoBBarUReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoBBarUVC, HptoBBarUTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoBBarUVC()) + HptoBBarUCT(n)
                else
                    UVChecks(1) = DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                                & HptoBBarUCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoBBarUVC()) + HptoBBarUCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                                    & HptoBBarUCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MB**4 + MU**4 - 2D0*MHp**2*MB**2 - 2D0*MHp**2*MU**2 &
                        &  - 2D0*MB**2*MU**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoBBarUVC()) + &
                                & 2D0*HptoBBarUCT(n) + &
                                & HptoBBarUReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoBBarUVC() + &
                                & HptoBBarUTad()) + 2D0*HptoBBarUCT(n) + &
                                & HptoBBarUReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoBBarUVC()) + &
                                    & 2D0*HptoBBarUCT(n) + HptoBBarUReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoBBarUVC() + &
                                    & HptoBBarUTad()) + 2D0*HptoBBarUCT(n) + &
                                    & HptoBBarUReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoBBarUReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoBBarUTree() + &
                        & 2D0*DBLE(HptoBBarUVC()) + HptoBBarUReal() + &
                        & 2D0*HptoBBarUCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoBBarUTree() + &
                        & 2D0*DBLE(HptoBBarUVC()) + HptoBBarUReal() + &
                        & 2D0*HptoBBarUCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoBBarUTree() + &
                        & 2D0*DBLE(HptoBBarUVC()) + HptoBBarUReal() + &
                        & 2D0*HptoBBarUCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoBBarUTree() + &
                        & 2D0*DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                        & HptoBBarUReal() + 2D0*HptoBBarUCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoBBarUTree() + &
                        & 2D0*DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                        & HptoBBarUReal() + 2D0*HptoBBarUCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoBBarUTree() + &
                            & 2D0*DBLE(HptoBBarUVC()) + 2D0*HptoBBarUCT(n) + &
                            & HptoBBarUReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoBBarUTree() + &
                            & 2D0*DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                            & 2D0*HptoBBarUCT(n) + HptoBBarUReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoBBarUTree() + &
                            & 2D0*DBLE(HptoBBarUVC()) + 2D0*HptoBBarUCT(n) + &
                            & HptoBBarUReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoBBarUTree() + &
                            & 2D0*DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                            & 2D0*HptoBBarUCT(n) + HptoBBarUReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoBBarUTree() + &
                            & 2D0*DBLE(HptoBBarUVC()) + 2D0*HptoBBarUCT(n) + &
                            & HptoBBarUReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoBBarUTree() + &
                            & 2D0*DBLE(HptoBBarUVC() + HptoBBarUTad()) + &
                            & 2D0*HptoBBarUCT(n) + HptoBBarUReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoBBarUTree()
