...
#include "looptools.h"
    ...
    double precision HptoCDBarTree, HptoCDBarCT, HptoCDBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoCDBarVC, HptoCDBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoCDBarVC()) + HptoCDBarCT(n)
                else
                    UVChecks(1) = DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                                & HptoCDBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoCDBarVC()) + HptoCDBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                                    & HptoCDBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MC**4 + MD**4 - 2D0*MHp**2*MC**2 - 2D0*MHp**2*MD**2 &
                        &  - 2D0*MC**2*MD**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoCDBarVC()) + &
                                & 2D0*HptoCDBarCT(n) + &
                                & HptoCDBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoCDBarVC() + &
                                & HptoCDBarTad()) + 2D0*HptoCDBarCT(n) + &
                                & HptoCDBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoCDBarVC()) + &
                                    & 2D0*HptoCDBarCT(n) + HptoCDBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoCDBarVC() + &
                                    & HptoCDBarTad()) + 2D0*HptoCDBarCT(n) + &
                                    & HptoCDBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoCDBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoCDBarTree() + &
                        & 2D0*DBLE(HptoCDBarVC()) + HptoCDBarReal() + &
                        & 2D0*HptoCDBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoCDBarTree() + &
                        & 2D0*DBLE(HptoCDBarVC()) + HptoCDBarReal() + &
                        & 2D0*HptoCDBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoCDBarTree() + &
                        & 2D0*DBLE(HptoCDBarVC()) + HptoCDBarReal() + &
                        & 2D0*HptoCDBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoCDBarTree() + &
                        & 2D0*DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                        & HptoCDBarReal() + 2D0*HptoCDBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoCDBarTree() + &
                        & 2D0*DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                        & HptoCDBarReal() + 2D0*HptoCDBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoCDBarTree() + &
                            & 2D0*DBLE(HptoCDBarVC()) + 2D0*HptoCDBarCT(n) + &
                            & HptoCDBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoCDBarTree() + &
                            & 2D0*DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                            & 2D0*HptoCDBarCT(n) + HptoCDBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoCDBarTree() + &
                            & 2D0*DBLE(HptoCDBarVC()) + 2D0*HptoCDBarCT(n) + &
                            & HptoCDBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoCDBarTree() + &
                            & 2D0*DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                            & 2D0*HptoCDBarCT(n) + HptoCDBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoCDBarTree() + &
                            & 2D0*DBLE(HptoCDBarVC()) + 2D0*HptoCDBarCT(n) + &
                            & HptoCDBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoCDBarTree() + &
                            & 2D0*DBLE(HptoCDBarVC() + HptoCDBarTad()) + &
                            & 2D0*HptoCDBarCT(n) + HptoCDBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoCDBarTree()
