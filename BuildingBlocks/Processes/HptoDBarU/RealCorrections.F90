double precision function HptoDBarUReal()
 use constants
 use counterterms
 implicit none
#include "looptools.h"
 ...
 totalAmplitude = 3D0*EL2*CKM11**2/(2D0*MW2*SW2)*(EL2/(2D0*(4D0*PI)**3*m1))*&
 ...
 HptoDBarUReal = totalAmplitude
end function HptoDBarUReal
