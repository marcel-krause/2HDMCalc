...
#include "looptools.h"
    ...
    double precision HptoDBarUTree, HptoDBarUCT, HptoDBarUReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoDBarUVC, HptoDBarUTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoDBarUVC()) + HptoDBarUCT(n)
                else
                    UVChecks(1) = DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                                & HptoDBarUCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoDBarUVC()) + HptoDBarUCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                                    & HptoDBarUCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MD**4 + MU**4 - 2D0*MHp**2*MD**2 - 2D0*MHp**2*MU**2 &
                        &  - 2D0*MD**2*MU**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoDBarUVC()) + &
                                & 2D0*HptoDBarUCT(n) + &
                                & HptoDBarUReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoDBarUVC() + &
                                & HptoDBarUTad()) + 2D0*HptoDBarUCT(n) + &
                                & HptoDBarUReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoDBarUVC()) + &
                                    & 2D0*HptoDBarUCT(n) + HptoDBarUReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoDBarUVC() + &
                                    & HptoDBarUTad()) + 2D0*HptoDBarUCT(n) + &
                                    & HptoDBarUReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoDBarUReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoDBarUTree() + &
                        & 2D0*DBLE(HptoDBarUVC()) + HptoDBarUReal() + &
                        & 2D0*HptoDBarUCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoDBarUTree() + &
                        & 2D0*DBLE(HptoDBarUVC()) + HptoDBarUReal() + &
                        & 2D0*HptoDBarUCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoDBarUTree() + &
                        & 2D0*DBLE(HptoDBarUVC()) + HptoDBarUReal() + &
                        & 2D0*HptoDBarUCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoDBarUTree() + &
                        & 2D0*DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                        & HptoDBarUReal() + 2D0*HptoDBarUCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoDBarUTree() + &
                        & 2D0*DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                        & HptoDBarUReal() + 2D0*HptoDBarUCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoDBarUTree() + &
                            & 2D0*DBLE(HptoDBarUVC()) + 2D0*HptoDBarUCT(n) + &
                            & HptoDBarUReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoDBarUTree() + &
                            & 2D0*DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                            & 2D0*HptoDBarUCT(n) + HptoDBarUReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoDBarUTree() + &
                            & 2D0*DBLE(HptoDBarUVC()) + 2D0*HptoDBarUCT(n) + &
                            & HptoDBarUReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoDBarUTree() + &
                            & 2D0*DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                            & 2D0*HptoDBarUCT(n) + HptoDBarUReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoDBarUTree() + &
                            & 2D0*DBLE(HptoDBarUVC()) + 2D0*HptoDBarUCT(n) + &
                            & HptoDBarUReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoDBarUTree() + &
                            & 2D0*DBLE(HptoDBarUVC() + HptoDBarUTad()) + &
                            & 2D0*HptoDBarUCT(n) + HptoDBarUReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoDBarUTree()
