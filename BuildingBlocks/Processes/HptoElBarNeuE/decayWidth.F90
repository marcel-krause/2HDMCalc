...
#include "looptools.h"
    ...
    double precision HptoElBarNeuETree, HptoElBarNeuECT, HptoElBarNeuEReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoElBarNeuEVC, HptoElBarNeuETad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoElBarNeuEVC()) + HptoElBarNeuECT(n)
                else
                    UVChecks(1) = DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                                & HptoElBarNeuECT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoElBarNeuEVC()) + HptoElBarNeuECT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                                    & HptoElBarNeuECT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + ME**4 + 0**4 - 2D0*MHp**2*ME**2 - 2D0*MHp**2*0**2 &
                        &  - 2D0*ME**2*0**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoElBarNeuEVC()) + &
                                & 2D0*HptoElBarNeuECT(n) + &
                                & HptoElBarNeuEReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoElBarNeuEVC() + &
                                & HptoElBarNeuETad()) + 2D0*HptoElBarNeuECT(n) + &
                                & HptoElBarNeuEReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoElBarNeuEVC()) + &
                                    & 2D0*HptoElBarNeuECT(n) + HptoElBarNeuEReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoElBarNeuEVC() + &
                                    & HptoElBarNeuETad()) + 2D0*HptoElBarNeuECT(n) + &
                                    & HptoElBarNeuEReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoElBarNeuEReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoElBarNeuETree() + &
                        & 2D0*DBLE(HptoElBarNeuEVC()) + HptoElBarNeuEReal() + &
                        & 2D0*HptoElBarNeuECT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoElBarNeuETree() + &
                        & 2D0*DBLE(HptoElBarNeuEVC()) + HptoElBarNeuEReal() + &
                        & 2D0*HptoElBarNeuECT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoElBarNeuETree() + &
                        & 2D0*DBLE(HptoElBarNeuEVC()) + HptoElBarNeuEReal() + &
                        & 2D0*HptoElBarNeuECT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoElBarNeuETree() + &
                        & 2D0*DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                        & HptoElBarNeuEReal() + 2D0*HptoElBarNeuECT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoElBarNeuETree() + &
                        & 2D0*DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                        & HptoElBarNeuEReal() + 2D0*HptoElBarNeuECT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoElBarNeuETree() + &
                            & 2D0*DBLE(HptoElBarNeuEVC()) + 2D0*HptoElBarNeuECT(n) + &
                            & HptoElBarNeuEReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoElBarNeuETree() + &
                            & 2D0*DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                            & 2D0*HptoElBarNeuECT(n) + HptoElBarNeuEReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoElBarNeuETree() + &
                            & 2D0*DBLE(HptoElBarNeuEVC()) + 2D0*HptoElBarNeuECT(n) + &
                            & HptoElBarNeuEReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoElBarNeuETree() + &
                            & 2D0*DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                            & 2D0*HptoElBarNeuECT(n) + HptoElBarNeuEReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoElBarNeuETree() + &
                            & 2D0*DBLE(HptoElBarNeuEVC()) + 2D0*HptoElBarNeuECT(n) + &
                            & HptoElBarNeuEReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoElBarNeuETree() + &
                            & 2D0*DBLE(HptoElBarNeuEVC() + HptoElBarNeuETad()) + &
                            & 2D0*HptoElBarNeuECT(n) + HptoElBarNeuEReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoElBarNeuETree()
