...
#include "looptools.h"
    ...
    double precision HptoHHWpTree, HptoHHWpCT, HptoHHWpReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoHHWpVC, HptoHHWpTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoHHWpVC()) + HptoHHWpCT(n)
                else
                    UVChecks(1) = DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                                & HptoHHWpCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoHHWpVC()) + HptoHHWpCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                                    & HptoHHWpCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MHH**4 + MW**4 - 2D0*MHp**2*MHH**2 - 2D0*MHp**2*MW**2 &
                        &  - 2D0*MHH**2*MW**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoHHWpVC()) + &
                                & 2D0*HptoHHWpCT(n) + &
                                & HptoHHWpReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoHHWpVC() + &
                                & HptoHHWpTad()) + 2D0*HptoHHWpCT(n) + &
                                & HptoHHWpReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoHHWpVC()) + &
                                    & 2D0*HptoHHWpCT(n) + HptoHHWpReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoHHWpVC() + &
                                    & HptoHHWpTad()) + 2D0*HptoHHWpCT(n) + &
                                    & HptoHHWpReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoHHWpReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoHHWpTree() + &
                        & 2D0*DBLE(HptoHHWpVC()) + HptoHHWpReal() + &
                        & 2D0*HptoHHWpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoHHWpTree() + &
                        & 2D0*DBLE(HptoHHWpVC()) + HptoHHWpReal() + &
                        & 2D0*HptoHHWpCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoHHWpTree() + &
                        & 2D0*DBLE(HptoHHWpVC()) + HptoHHWpReal() + &
                        & 2D0*HptoHHWpCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoHHWpTree() + &
                        & 2D0*DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                        & HptoHHWpReal() + 2D0*HptoHHWpCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoHHWpTree() + &
                        & 2D0*DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                        & HptoHHWpReal() + 2D0*HptoHHWpCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoHHWpTree() + &
                            & 2D0*DBLE(HptoHHWpVC()) + 2D0*HptoHHWpCT(n) + &
                            & HptoHHWpReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoHHWpTree() + &
                            & 2D0*DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                            & 2D0*HptoHHWpCT(n) + HptoHHWpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoHHWpTree() + &
                            & 2D0*DBLE(HptoHHWpVC()) + 2D0*HptoHHWpCT(n) + &
                            & HptoHHWpReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoHHWpTree() + &
                            & 2D0*DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                            & 2D0*HptoHHWpCT(n) + HptoHHWpReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoHHWpTree() + &
                            & 2D0*DBLE(HptoHHWpVC()) + 2D0*HptoHHWpCT(n) + &
                            & HptoHHWpReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoHHWpTree() + &
                            & 2D0*DBLE(HptoHHWpVC() + HptoHHWpTad()) + &
                            & 2D0*HptoHHWpCT(n) + HptoHHWpReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoHHWpTree()
