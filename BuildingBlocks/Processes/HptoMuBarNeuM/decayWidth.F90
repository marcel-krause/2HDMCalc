...
#include "looptools.h"
    ...
    double precision HptoMuBarNeuMTree, HptoMuBarNeuMCT, HptoMuBarNeuMReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoMuBarNeuMVC, HptoMuBarNeuMTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoMuBarNeuMVC()) + HptoMuBarNeuMCT(n)
                else
                    UVChecks(1) = DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                                & HptoMuBarNeuMCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoMuBarNeuMVC()) + HptoMuBarNeuMCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                                    & HptoMuBarNeuMCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MM**4 + 0**4 - 2D0*MHp**2*MM**2 - 2D0*MHp**2*0**2 &
                        &  - 2D0*MM**2*0**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoMuBarNeuMVC()) + &
                                & 2D0*HptoMuBarNeuMCT(n) + &
                                & HptoMuBarNeuMReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoMuBarNeuMVC() + &
                                & HptoMuBarNeuMTad()) + 2D0*HptoMuBarNeuMCT(n) + &
                                & HptoMuBarNeuMReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoMuBarNeuMVC()) + &
                                    & 2D0*HptoMuBarNeuMCT(n) + HptoMuBarNeuMReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoMuBarNeuMVC() + &
                                    & HptoMuBarNeuMTad()) + 2D0*HptoMuBarNeuMCT(n) + &
                                    & HptoMuBarNeuMReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoMuBarNeuMReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoMuBarNeuMTree() + &
                        & 2D0*DBLE(HptoMuBarNeuMVC()) + HptoMuBarNeuMReal() + &
                        & 2D0*HptoMuBarNeuMCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoMuBarNeuMTree() + &
                        & 2D0*DBLE(HptoMuBarNeuMVC()) + HptoMuBarNeuMReal() + &
                        & 2D0*HptoMuBarNeuMCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoMuBarNeuMTree() + &
                        & 2D0*DBLE(HptoMuBarNeuMVC()) + HptoMuBarNeuMReal() + &
                        & 2D0*HptoMuBarNeuMCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoMuBarNeuMTree() + &
                        & 2D0*DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                        & HptoMuBarNeuMReal() + 2D0*HptoMuBarNeuMCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoMuBarNeuMTree() + &
                        & 2D0*DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                        & HptoMuBarNeuMReal() + 2D0*HptoMuBarNeuMCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoMuBarNeuMTree() + &
                            & 2D0*DBLE(HptoMuBarNeuMVC()) + 2D0*HptoMuBarNeuMCT(n) + &
                            & HptoMuBarNeuMReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoMuBarNeuMTree() + &
                            & 2D0*DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                            & 2D0*HptoMuBarNeuMCT(n) + HptoMuBarNeuMReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoMuBarNeuMTree() + &
                            & 2D0*DBLE(HptoMuBarNeuMVC()) + 2D0*HptoMuBarNeuMCT(n) + &
                            & HptoMuBarNeuMReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoMuBarNeuMTree() + &
                            & 2D0*DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                            & 2D0*HptoMuBarNeuMCT(n) + HptoMuBarNeuMReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoMuBarNeuMTree() + &
                            & 2D0*DBLE(HptoMuBarNeuMVC()) + 2D0*HptoMuBarNeuMCT(n) + &
                            & HptoMuBarNeuMReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoMuBarNeuMTree() + &
                            & 2D0*DBLE(HptoMuBarNeuMVC() + HptoMuBarNeuMTad()) + &
                            & 2D0*HptoMuBarNeuMCT(n) + HptoMuBarNeuMReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoMuBarNeuMTree()
