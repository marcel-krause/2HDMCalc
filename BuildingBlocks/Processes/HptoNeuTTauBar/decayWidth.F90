...
#include "looptools.h"
    ...
    double precision HptoNeuTTauBarTree, HptoNeuTTauBarCT, HptoNeuTTauBarReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoNeuTTauBarVC, HptoNeuTTauBarTad, vertexCorrectionsTemp, vertexTadpolesTemp
    ...
    if (arguments(1) == 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoNeuTTauBarVC()) + HptoNeuTTauBarCT(n)
                else
                    UVChecks(1) = DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                                & HptoNeuTTauBarCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoNeuTTauBarVC()) + HptoNeuTTauBarCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                                    & HptoNeuTTauBarCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + 0**4 + ML**4 - 2D0*MHp**2*0**2 - 2D0*MHp**2*ML**2 &
                        &  - 2D0*0**2*ML**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoNeuTTauBarVC()) + &
                                & 2D0*HptoNeuTTauBarCT(n) + &
                                & HptoNeuTTauBarReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoNeuTTauBarVC() + &
                                & HptoNeuTTauBarTad()) + 2D0*HptoNeuTTauBarCT(n) + &
                                & HptoNeuTTauBarReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoNeuTTauBarVC()) + &
                                    & 2D0*HptoNeuTTauBarCT(n) + HptoNeuTTauBarReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoNeuTTauBarVC() + &
                                    & HptoNeuTTauBarTad()) + 2D0*HptoNeuTTauBarCT(n) + &
                                    & HptoNeuTTauBarReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoNeuTTauBarReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoNeuTTauBarTree() + &
                        & 2D0*DBLE(HptoNeuTTauBarVC()) + HptoNeuTTauBarReal() + &
                        & 2D0*HptoNeuTTauBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoNeuTTauBarTree() + &
                        & 2D0*DBLE(HptoNeuTTauBarVC()) + HptoNeuTTauBarReal() + &
                        & 2D0*HptoNeuTTauBarCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoNeuTTauBarTree() + &
                        & 2D0*DBLE(HptoNeuTTauBarVC()) + HptoNeuTTauBarReal() + &
                        & 2D0*HptoNeuTTauBarCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoNeuTTauBarTree() + &
                        & 2D0*DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                        & HptoNeuTTauBarReal() + 2D0*HptoNeuTTauBarCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoNeuTTauBarTree() + &
                        & 2D0*DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                        & HptoNeuTTauBarReal() + 2D0*HptoNeuTTauBarCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoNeuTTauBarTree() + &
                            & 2D0*DBLE(HptoNeuTTauBarVC()) + 2D0*HptoNeuTTauBarCT(n) + &
                            & HptoNeuTTauBarReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoNeuTTauBarTree() + &
                            & 2D0*DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                            & 2D0*HptoNeuTTauBarCT(n) + HptoNeuTTauBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoNeuTTauBarTree() + &
                            & 2D0*DBLE(HptoNeuTTauBarVC()) + 2D0*HptoNeuTTauBarCT(n) + &
                            & HptoNeuTTauBarReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoNeuTTauBarTree() + &
                            & 2D0*DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                            & 2D0*HptoNeuTTauBarCT(n) + HptoNeuTTauBarReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoNeuTTauBarTree() + &
                            & 2D0*DBLE(HptoNeuTTauBarVC()) + 2D0*HptoNeuTTauBarCT(n) + &
                            & HptoNeuTTauBarReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoNeuTTauBarTree() + &
                            & 2D0*DBLE(HptoNeuTTauBarVC() + HptoNeuTTauBarTad()) + &
                            & 2D0*HptoNeuTTauBarCT(n) + HptoNeuTTauBarReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoNeuTTauBarTree()
