double precision function HptoSBarTReal()
 use constants
 use counterterms
 implicit none
#include "looptools.h"
...
!    & (Qssv0 + Qssv1)**2*Ossv33
 ...
 totalAmplitude = 3D0*EL2*CKM32**2/(2D0*MW2*SW2)*(EL2/(2D0*(4D0*PI)**3*m1))*&
 ...
 HptoSBarTReal = totalAmplitude
end function HptoSBarTReal
