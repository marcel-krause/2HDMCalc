...
#include "looptools.h"
    ...
    double precision HptoSBarTTree, HptoSBarTCT, HptoSBarTReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoSBarTVC, HptoSBarTTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoSBarTVC()) + HptoSBarTCT(n)
                else
                    UVChecks(1) = DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                                & HptoSBarTCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoSBarTVC()) + HptoSBarTCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                                    & HptoSBarTCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MS**4 + MT**4 - 2D0*MHp**2*MS**2 - 2D0*MHp**2*MT**2 &
                        &  - 2D0*MS**2*MT**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoSBarTVC()) + &
                                & 2D0*HptoSBarTCT(n) + &
                                & HptoSBarTReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoSBarTVC() + &
                                & HptoSBarTTad()) + 2D0*HptoSBarTCT(n) + &
                                & HptoSBarTReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoSBarTVC()) + &
                                    & 2D0*HptoSBarTCT(n) + HptoSBarTReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoSBarTVC() + &
                                    & HptoSBarTTad()) + 2D0*HptoSBarTCT(n) + &
                                    & HptoSBarTReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoSBarTReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoSBarTTree() + &
                        & 2D0*DBLE(HptoSBarTVC()) + HptoSBarTReal() + &
                        & 2D0*HptoSBarTCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoSBarTTree() + &
                        & 2D0*DBLE(HptoSBarTVC()) + HptoSBarTReal() + &
                        & 2D0*HptoSBarTCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoSBarTTree() + &
                        & 2D0*DBLE(HptoSBarTVC()) + HptoSBarTReal() + &
                        & 2D0*HptoSBarTCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoSBarTTree() + &
                        & 2D0*DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                        & HptoSBarTReal() + 2D0*HptoSBarTCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoSBarTTree() + &
                        & 2D0*DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                        & HptoSBarTReal() + 2D0*HptoSBarTCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoSBarTTree() + &
                            & 2D0*DBLE(HptoSBarTVC()) + 2D0*HptoSBarTCT(n) + &
                            & HptoSBarTReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoSBarTTree() + &
                            & 2D0*DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                            & 2D0*HptoSBarTCT(n) + HptoSBarTReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoSBarTTree() + &
                            & 2D0*DBLE(HptoSBarTVC()) + 2D0*HptoSBarTCT(n) + &
                            & HptoSBarTReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoSBarTTree() + &
                            & 2D0*DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                            & 2D0*HptoSBarTCT(n) + HptoSBarTReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoSBarTTree() + &
                            & 2D0*DBLE(HptoSBarTVC()) + 2D0*HptoSBarTCT(n) + &
                            & HptoSBarTReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoSBarTTree() + &
                            & 2D0*DBLE(HptoSBarTVC() + HptoSBarTTad()) + &
                            & 2D0*HptoSBarTCT(n) + HptoSBarTReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoSBarTTree()
