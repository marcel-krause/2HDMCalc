...
#include "looptools.h"
    ...
    double precision HptoSBarUTree, HptoSBarUCT, HptoSBarUReal, treeLevelTemp, realCorrectionsTemp
    double complex HptoSBarUVC, HptoSBarUTad, vertexCorrectionsTemp, vertexTadpolesTemp
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    UVChecks(1) = DBLE(HptoSBarUVC()) + HptoSBarUCT(n)
                else
                    UVChecks(1) = DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                                & HptoSBarUCT(n)
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        UVChecks(m) = ( DBLE(HptoSBarUVC()) + HptoSBarUCT(n) - &
                                    & UVChecks(1) )/UVChecks(1)
                    else
                        UVChecks(m) = ( DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                                    & HptoSBarUCT(n) - UVChecks(1) &
                                    & )/UVChecks(1)
                    end if
    ...
    if (arguments(2) == 1) then
        ...
        call ltini
            ...
            prefactor = 1D0/1D0 * DSQRT(MHp**4 + MS**4 + MU**4 - 2D0*MHp**2*MS**2 - 2D0*MHp**2*MU**2 &
                        &  - 2D0*MS**2*MU**2 )/(16D0*PI*MHp**3)
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoSBarUVC()) + &
                                & 2D0*HptoSBarUCT(n) + &
                                & HptoSBarUReal() )
                else
                    IRChecks(1) = prefactor*( 2D0*DBLE(HptoSBarUVC() + &
                                & HptoSBarUTad()) + 2D0*HptoSBarUCT(n) + &
                                & HptoSBarUReal() )
                end if
                do m = 2, 10, 1
                    call clearcache
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoSBarUVC()) + &
                                    & 2D0*HptoSBarUCT(n) + HptoSBarUReal() ) &
                                    & - IRChecks(1))/IRChecks(1)
                    else
                        IRChecks(m) = ( prefactor*( 2D0*DBLE(HptoSBarUVC() + &
                                    & HptoSBarUTad()) + 2D0*HptoSBarUCT(n) + &
                                    & HptoSBarUReal() ) - IRChecks(1))/IRChecks(1)
                    end if
                    print *, "Lambda: ", getlambda(), ", Difference from lambda=1: ", IRChecks(m)
                    print *, "Real: ", HptoSBarUReal()
    ...
    if (arguments(3) >= 1) then
        ...
        call ltini
            ...
            do n = 1, maxNumberSchemes, 1
                ...
                if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                    call clearcache
                    GaugeXiAChecks(5) = HptoSBarUTree() + &
                        & 2D0*DBLE(HptoSBarUVC()) + HptoSBarUReal() + &
                        & 2D0*HptoSBarUCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoSBarUTree() + &
                        & 2D0*DBLE(HptoSBarUVC()) + HptoSBarUReal() + &
                        & 2D0*HptoSBarUCT(n)
                    call clearcache
                    GaugeXiZChecks(5) = HptoSBarUTree() + &
                        & 2D0*DBLE(HptoSBarUVC()) + HptoSBarUReal() + &
                        & 2D0*HptoSBarUCT(n)
                else
                    call clearcache
                    GaugeXiAChecks(5) = HptoSBarUTree() + &
                        & 2D0*DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                        & HptoSBarUReal() + 2D0*HptoSBarUCT(n)
                    call clearcache
                    GaugeXiWChecks(5) = HptoSBarUTree() + &
                        & 2D0*DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                        & HptoSBarUReal() + 2D0*HptoSBarUCT(n)
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiAChecks(m) = ( HptoSBarUTree() + &
                            & 2D0*DBLE(HptoSBarUVC()) + 2D0*HptoSBarUCT(n) + &
                            & HptoSBarUReal() - GaugeXiAChecks(5) )/GaugeXiAChecks(5)
                    else
                        GaugeXiAChecks(m) = ( HptoSBarUTree() + &
                            & 2D0*DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                            & 2D0*HptoSBarUCT(n) + HptoSBarUReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiWChecks(m) = ( HptoSBarUTree() + &
                            & 2D0*DBLE(HptoSBarUVC()) + 2D0*HptoSBarUCT(n) + &
                            & HptoSBarUReal() - GaugeXiWChecks(5) )/GaugeXiWChecks(5)
                    else
                        GaugeXiWChecks(m) = ( HptoSBarUTree() + &
                            & 2D0*DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                            & 2D0*HptoSBarUCT(n) + HptoSBarUReal() - &
                ...
                do m = 1, 10, 1
                    ...
                    ! Schemes 1, 2, 9, 11 and 13 are without tadpoles
                    if ((n == 1) .OR. (n == 2) .OR. (n == 9) .OR. (n == 11) .OR. (n == 13)) then
                        GaugeXiZChecks(m) = ( HptoSBarUTree() + &
                            & 2D0*DBLE(HptoSBarUVC()) + 2D0*HptoSBarUCT(n) + &
                            & HptoSBarUReal() - GaugeXiZChecks(5) )/GaugeXiZChecks(5)
                    else
                        GaugeXiZChecks(m) = ( HptoSBarUTree() + &
                            & 2D0*DBLE(HptoSBarUVC() + HptoSBarUTad()) + &
                            & 2D0*HptoSBarUCT(n) + HptoSBarUReal() - &
    ...
    if (arguments(4) == 1) then
        ...
        call ltini
            ...
            do point = 1, maxPoint, 1
                ...
                call clearcache
                treeLevelWidth = prefactor*HptoSBarUTree()
