...
#include "looptools.h"
 ...
 amplitudes(99) = (0.015625D0*CKM13*CKMC13*EL2*(-1.D0*MB2*A0(MU2) + MB2*A0(GaugeXiW*MW2) + MB2*MU2*B0(x, MU2, GaugeXiW*MW2) - 1.D&
  &0*GaugeXiW*MB2*MW2*B0(x, MU2, GaugeXiW*MW2) + MB2*x*B0(x, MU2, GaugeXiW*MW2)))/(MW2*PI2*SW2*x)

 amplitudes(100) = (0.015625D0*CKM23*CKMC23*EL2*(-1.D0*MB2*A0(MC2) + MB2*A0(GaugeXiW*MW2) + MB2*MC2*B0(x, MC2, GaugeXiW*MW2) - 1.&
  &D0*GaugeXiW*MB2*MW2*B0(x, MC2, GaugeXiW*MW2) + MB2*x*B0(x, MC2, GaugeXiW*MW2)))/(MW2*PI2*SW2*x)

 amplitudes(101) = (0.015625D0*CKM33*CKMC33*EL2*(-1.D0*MB2*A0(MT2) + MB2*A0(GaugeXiW*MW2) + MB2*MT2*B0(x, MT2, GaugeXiW*MW2) - 1.&
  &D0*GaugeXiW*MB2*MW2*B0(x, MT2, GaugeXiW*MW2) + MB2*x*B0(x, MT2, GaugeXiW*MW2)))/(MW2*PI2*SW2*x)
 ...
 amplitudes(103) = (0.0008680555555555555D0*EL2*(-8.D0*MZ2*x*DBLE(SW**INT(4.D0)) - 8.D0*MZ2*A0(MB2)*DBLE(SW**INT(4.D0)) + 4.D0*MB&
  &2*A0(MZ2)*DBLE(SW**INT(4.D0)) + 8.D0*MZ2*A0(MZ2)*DBLE(SW**INT(4.D0)) - 4.D0*x*A0(MZ2)*DBLE(SW**INT(4.D0)) - 4.D0*MB2*A0(GaugeX&
  &iZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*x*A0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MB2*MZ2*B0(x, MB2, MZ2)*DBLE(SW**INT(4.D0)) -&
  & 8.D0*MB2*x*B0(x, MB2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MZ2*x*B0(x, MB2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MB2*MZ2*B0(x,&
  & MB2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 8.D0*MB2*x*B0(x, MB2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MZ2*x*B0(x, &
  &MB2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, MB2, MZ2)*DBLE(MB**INT(4.D0))*DBLE(SW**INT(4.D0)) - 4.D0*B0(x, MB2, GaugeX&
  &iZ*MZ2)*DBLE(MB**INT(4.D0))*DBLE(SW**INT(4.D0)) - 8.D0*B0(x, MB2, MZ2)*DBLE(MZ**INT(4.D0))*DBLE(SW**INT(4.D0)) + 4.D0*B0(x, MB&
  &2, MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0)) - 4.D0*B0(x, MB2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0))))/(CW2*M&
  &Z2*PI2*SW2*x)
