double complex function SelfBBScalarAlter(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(92) = (0.015625D0*EL2*MB2*B0(x, MB2, Mh02)*DBLE(Yuk1**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(93) = (0.015625D0*EL2*MB2*B0(x, MB2, MHH2)*DBLE(Yuk2**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(94) = (-0.015625D0*EL2*MB2*B0(x, MA02, MB2)*DBLE(Yuk3**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(95) = (-0.015625D0*EL2*MB2*B0(x, MB2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)

 amplitudes(96) = (0.03125D0*CKM13*CKMC13*EL2*MU2*Yuk3*B0(x, MHp2, MU2))/(MW2*PI2*SW2*TB)

 amplitudes(97) = (0.03125D0*CKM23*CKMC23*EL2*MC2*Yuk3*B0(x, MC2, MHp2))/(MW2*PI2*SW2*TB)

 amplitudes(98) = (0.03125D0*CKM33*CKMC33*EL2*MT2*Yuk3*B0(x, MHp2, MT2))/(MW2*PI2*SW2*TB)

 amplitudes(99) = (-0.03125D0*CKM13*CKMC13*EL2*MU2*B0(x, MU2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(100) = (-0.03125D0*CKM23*CKMC23*EL2*MC2*B0(x, MC2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(101) = (-0.03125D0*CKM33*CKMC33*EL2*MT2*B0(x, MT2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(102) = (-0.006944444444444444D0*EL2*(-2.D0 + (3.D0 + GaugeXiA)*B0(x, 0.D0, MB2)))/PI2

 amplitudes(103) = (-0.003472222222222222D0*EL2*(-3.D0 + 2.D0*SW2)*(-2.D0 + 3.D0*B0(x, MB2, MZ2) + GaugeXiZ*B0(x, MB2, GaugeXiZ*M&
  &Z2)))/(CW2*PI2)
 ...
 SelfBBScalarAlter = totalAmplitude
end function SelfBBScalarAlter
