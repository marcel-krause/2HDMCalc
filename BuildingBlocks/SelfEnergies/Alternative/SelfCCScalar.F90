double complex function SelfCCScalarAlter(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(92) = (0.015625D0*CA2*EL2*MC2*B0(x, MC2, Mh02))/(MW2*PI2*SB2*SW2)

 amplitudes(93) = (0.015625D0*EL2*MC2*SA2*B0(x, MC2, MHH2))/(MW2*PI2*SB2*SW2)
 ...
 amplitudes(97) = (0.03125D0*CKM22*CKMC22*EL2*MS2*Yuk3*B0(x, MHp2, MS2))/(MW2*PI2*SW2*TB)
 ...
 SelfCCScalarAlter = totalAmplitude
end function SelfCCScalarAlter
