double complex function SelfMuMuScalarAlter(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(92) = (0.015625D0*EL2*MM2*B0(x, Mh02, MM2)*DBLE(Yuk4**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(93) = (0.015625D0*EL2*MM2*B0(x, MHH2, MM2)*DBLE(Yuk5**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(94) = (-0.015625D0*EL2*MM2*B0(x, MA02, MM2)*DBLE(Yuk6**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(95) = (-0.015625D0*EL2*MM2*B0(x, MM2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)

 amplitudes(96) = 0.D0

 amplitudes(97) = 0.D0

 amplitudes(98) = (-0.0625D0*EL2*(-2.D0 + (3.D0 + GaugeXiA)*B0(x, 0.D0, MM2)))/PI2

 amplitudes(99) = (-0.03125D0*EL2*(-1.D0 + 2.D0*SW2)*(-2.D0 + 3.D0*B0(x, MM2, MZ2) + GaugeXiZ*B0(x, MM2, GaugeXiZ*MZ2)))/(CW2*PI2&
  &)
 ...
 SelfMuMuScalarAlter = totalAmplitude
end function SelfMuMuScalarAlter
