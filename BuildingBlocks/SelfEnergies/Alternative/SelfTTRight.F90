double complex function SelfTTRightAlter(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(97) = (0.015625D0*CKM32*CKMC32*EL2*(MT2*A0(MHp2) - 1.D0*MT2*A0(MS2) - 1.D0*MHp2*MT2*B0(x, MHp2, MS2) + MS2*MT2*B0(x, &
  &MHp2, MS2) + MT2*x*B0(x, MHp2, MS2)))/(MW2*PI2*SW2*TB2*x)
 ...
 SelfTTRightAlter = totalAmplitude
end function SelfTTRightAlter
