...
#include "looptools.h"
 ...
 amplitudes(95) = (-0.015625D0*EL2*MT2*B0(x, MT2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(99) = (-0.03125D0*CKM31*CKMC31*EL2*MD2*B0(x, MD2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(100) = (-0.03125D0*CKM32*CKMC32*EL2*MS2*B0(x, MS2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(101) = (-0.03125D0*CKM33*CKMC33*EL2*MB2*B0(x, MB2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(102) = (-0.027777777777777776D0*EL2*(-2.D0 + (3.D0 + GaugeXiA)*B0(x, 0.D0, MT2)))/PI2

 amplitudes(103) = (-0.006944444444444444D0*EL2*(-3.D0 + 4.D0*SW2)*(-2.D0 + 3.D0*B0(x, MT2, MZ2) + GaugeXiZ*B0(x, MT2, GaugeXiZ*M&
  &Z2)))/(CW2*PI2)
