double complex function SelfTauTauScalarWeakAlter(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(78) = (0.015625D0*EL2*ML2*B0(x, Mh02, ML2)*DBLE(Yuk4**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(79) = (0.015625D0*EL2*ML2*B0(x, MHH2, ML2)*DBLE(Yuk5**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(80) = (-0.015625D0*EL2*ML2*B0(x, MA02, ML2)*DBLE(Yuk6**INT(2.D0)))/(MW2*PI2*SW2)

 amplitudes(81) = (-0.015625D0*EL2*ML2*B0(x, ML2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)

 amplitudes(82) = 0.D0

 amplitudes(83) = 0.D0

 amplitudes(84) = (-0.03125D0*EL2*(-1.D0 + 2.D0*SW2)*(-2.D0 + 3.D0*B0(x, ML2, MZ2) + GaugeXiZ*B0(x, ML2, GaugeXiZ*MZ2)))/(CW2*PI2&
  &)
 ...
 SelfTauTauScalarWeakAlter = totalAmplitude
end function SelfTauTauScalarWeakAlter
