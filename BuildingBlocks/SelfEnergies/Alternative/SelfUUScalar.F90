double complex function SelfUUScalarAlter(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(92) = (0.015625D0*CA2*EL2*MU2*B0(x, Mh02, MU2))/(MW2*PI2*SB2*SW2)

 amplitudes(93) = (0.015625D0*EL2*MU2*SA2*B0(x, MHH2, MU2))/(MW2*PI2*SB2*SW2)

 amplitudes(94) = (-0.015625D0*EL2*MU2*B0(x, MA02, MU2))/(MW2*PI2*SW2*TB2)

 amplitudes(95) = (-0.015625D0*EL2*MU2*B0(x, MU2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)

 amplitudes(96) = (0.03125D0*CKM11*CKMC11*EL2*MD2*Yuk3*B0(x, MD2, MHp2))/(MW2*PI2*SW2*TB)

 amplitudes(97) = (0.03125D0*CKM12*CKMC12*EL2*MS2*Yuk3*B0(x, MHp2, MS2))/(MW2*PI2*SW2*TB)

 amplitudes(98) = (0.03125D0*CKM13*CKMC13*EL2*MB2*Yuk3*B0(x, MB2, MHp2))/(MW2*PI2*SW2*TB)

 amplitudes(99) = (-0.03125D0*CKM11*CKMC11*EL2*MD2*B0(x, MD2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(100) = (-0.03125D0*CKM12*CKMC12*EL2*MS2*B0(x, MS2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(101) = (-0.03125D0*CKM13*CKMC13*EL2*MB2*B0(x, MB2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(102) = (-0.027777777777777776D0*EL2*(-2.D0 + (3.D0 + GaugeXiA)*B0(x, 0.D0, MU2)))/PI2

 amplitudes(103) = (-0.006944444444444444D0*EL2*(-3.D0 + 4.D0*SW2)*(-2.D0 + 3.D0*B0(x, MU2, MZ2) + GaugeXiZ*B0(x, MU2, GaugeXiZ*M&
  &Z2)))/(CW2*PI2)
 ...
 SelfUUScalarAlter = totalAmplitude
end function SelfUUScalarAlter
