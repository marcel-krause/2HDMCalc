...
#include "looptools.h"
 ...
 amplitudes(8) = (0.015625D0*CKM21*CKMC21*EL2*(-1.D0*MD2*A0(MD2) + MD2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MD2*MW2*B0(x, MD2, GaugeX&
  &iW*MW2) + MD2*x*B0(x, MD2, GaugeXiW*MW2) + B0(x, MD2, GaugeXiW*MW2)*DBLE(MD**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(9) = (0.015625D0*CKM22*CKMC22*EL2*(-1.D0*MS2*A0(MS2) + MS2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MS2*MW2*B0(x, MS2, GaugeX&
  &iW*MW2) + MS2*x*B0(x, MS2, GaugeXiW*MW2) + B0(x, MS2, GaugeXiW*MW2)*DBLE(MS**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(10) = (0.015625D0*CKM23*CKMC23*EL2*(-1.D0*MB2*A0(MB2) + MB2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MB2*MW2*B0(x, MB2, Gauge&
 ...
 amplitudes(12) = (0.0008680555555555555D0*EL2*(-18.D0*MZ2*x + 48.D0*MZ2*SW2*x - 18.D0*MZ2*A0(MC2) + 48.D0*MZ2*SW2*A0(MC2) + 9.D0&
  &*MC2*A0(MZ2) + 18.D0*MZ2*A0(MZ2) - 24.D0*MC2*SW2*A0(MZ2) - 48.D0*MZ2*SW2*A0(MZ2) - 9.D0*x*A0(MZ2) + 24.D0*SW2*x*A0(MZ2) - 9.D0&
  &*MC2*A0(GaugeXiZ*MZ2) + 24.D0*MC2*SW2*A0(GaugeXiZ*MZ2) + 9.D0*x*A0(GaugeXiZ*MZ2) - 24.D0*SW2*x*A0(GaugeXiZ*MZ2) + 9.D0*MC2*MZ2&
  &*B0(x, MC2, MZ2) - 24.D0*MC2*MZ2*SW2*B0(x, MC2, MZ2) - 18.D0*MC2*x*B0(x, MC2, MZ2) + 9.D0*MZ2*x*B0(x, MC2, MZ2) + 48.D0*MC2*SW&
  &2*x*B0(x, MC2, MZ2) - 24.D0*MZ2*SW2*x*B0(x, MC2, MZ2) + 9.D0*GaugeXiZ*MC2*MZ2*B0(x, MC2, GaugeXiZ*MZ2) - 24.D0*GaugeXiZ*MC2*MZ&
  &2*SW2*B0(x, MC2, GaugeXiZ*MZ2) + 18.D0*MC2*x*B0(x, MC2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ2*x*B0(x, MC2, GaugeXiZ*MZ2) - 48.D0*M&
  &C2*SW2*x*B0(x, MC2, GaugeXiZ*MZ2) - 24.D0*GaugeXiZ*MZ2*SW2*x*B0(x, MC2, GaugeXiZ*MZ2) + 9.D0*B0(x, MC2, MZ2)*DBLE(MC**INT(4.D0&
  &)) - 24.D0*SW2*B0(x, MC2, MZ2)*DBLE(MC**INT(4.D0)) - 9.D0*B0(x, MC2, GaugeXiZ*MZ2)*DBLE(MC**INT(4.D0)) + 24.D0*SW2*B0(x, MC2, &
  ...
  &A0(MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*x*A0(MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*MC2*A0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*x*A&
  &0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MC2*MZ2*B0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)) - 32.D0*MC2*x*B0(x, MC2, MZ2)*DBLE(SW*&
  &*INT(4.D0)) + 16.D0*MZ2*x*B0(x, MC2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*MC2*MZ2*B0(x, MC2, GaugeXiZ*MZ2)*DBLE(SW**INT(4&
  &.D0)) + 32.D0*MC2*x*B0(x, MC2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*MZ2*x*B0(x, MC2, GaugeXiZ*MZ2)*DBLE(SW**INT(&
  &4.D0)) + 16.D0*B0(x, MC2, MZ2)*DBLE(MC**INT(4.D0))*DBLE(SW**INT(4.D0)) - 16.D0*B0(x, MC2, GaugeXiZ*MZ2)*DBLE(MC**INT(4.D0))*DB&
  &LE(SW**INT(4.D0)) - 32.D0*B0(x, MC2, MZ2)*DBLE(MZ**INT(4.D0))*DBLE(SW**INT(4.D0)) + 9.D0*B0(x, MC2, MZ2)*DBLE(x**INT(2.D0)) - &
  &24.D0*SW2*B0(x, MC2, MZ2)*DBLE(x**INT(2.D0)) - 9.D0*B0(x, MC2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 24.D0*SW2*B0(x, MC2, GaugeXi&
  &Z*MZ2)*DBLE(x**INT(2.D0)) + 16.D0*B0(x, MC2, MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0)) - 16.D0*B0(x, MC2, GaugeXiZ*MZ2)*DBLE&
  &(SW**INT(4.D0))*DBLE(x**INT(2.D0))))/(CW2*MZ2*PI2*SW2*x)

 amplitudes(13) = (0.015625D0*CKM21*CKMC21*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MD2) + (MD2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MD2*A0(&
 ...
 amplitudes(14) = (0.015625D0*CKM22*CKMC22*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MS2) + (MS2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MS2*A0(&
 ...
 amplitudes(15) = (0.015625D0*CKM23*CKMC23*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MB2) + (MB2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MB2*A0(&
