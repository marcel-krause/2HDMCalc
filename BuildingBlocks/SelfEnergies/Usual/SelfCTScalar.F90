double complex function SelfCTScalarUsual(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(1) = (0.03125D0*CKM31*CKMC21*EL2*MD2*Yuk3*B0(x, MD2, MHp2))/(MW2*PI2*SW2*TB)

 amplitudes(2) = (0.03125D0*CKM32*CKMC22*EL2*MS2*Yuk3*B0(x, MHp2, MS2))/(MW2*PI2*SW2*TB)
 ...
 SelfCTScalarUsual = totalAmplitude
end function SelfCTScalarUsual
