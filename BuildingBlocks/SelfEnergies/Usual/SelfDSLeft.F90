double complex function SelfDSLeftUsual(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(1) = (0.015625D0*CKM11*CKMC12*EL2*(MU2*A0(MHp2) - 1.D0*MU2*A0(MU2) - 1.D0*MHp2*MU2*B0(x, MHp2, MU2) + MU2*x*B0(x, MHp&
  &2, MU2) + B0(x, MHp2, MU2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*TB2*x)

 amplitudes(2) = (0.015625D0*CKM21*CKMC22*EL2*(-1.D0*MC2*A0(MC2) + MC2*A0(MHp2) - 1.D0*MC2*MHp2*B0(x, MC2, MHp2) + MC2*x*B0(x, MC&
  &2, MHp2) + B0(x, MC2, MHp2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*TB2*x)

 amplitudes(3) = (0.015625D0*CKM31*CKMC32*EL2*(MT2*A0(MHp2) - 1.D0*MT2*A0(MT2) - 1.D0*MHp2*MT2*B0(x, MHp2, MT2) + MT2*x*B0(x, MHp&
  &2, MT2) + B0(x, MHp2, MT2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*TB2*x)

 amplitudes(4) = (0.015625D0*CKM11*CKMC12*EL2*(-1.D0*MU2*A0(MU2) + MU2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MU2*MW2*B0(x, MU2, GaugeX&
  &iW*MW2) + MU2*x*B0(x, MU2, GaugeXiW*MW2) + B0(x, MU2, GaugeXiW*MW2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(5) = (0.015625D0*CKM21*CKMC22*EL2*(-1.D0*MC2*A0(MC2) + MC2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MC2*MW2*B0(x, MC2, GaugeX&
  &iW*MW2) + MC2*x*B0(x, MC2, GaugeXiW*MW2) + B0(x, MC2, GaugeXiW*MW2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(6) = (0.015625D0*CKM31*CKMC32*EL2*(-1.D0*MT2*A0(MT2) + MT2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MT2*MW2*B0(x, MT2, GaugeX&
  &iW*MW2) + MT2*x*B0(x, MT2, GaugeXiW*MW2) + B0(x, MT2, GaugeXiW*MW2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(7) = (0.015625D0*CKM11*CKMC12*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MU2) + (MU2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MU2*A0(G&
 ...
 amplitudes(8) = (0.015625D0*CKM21*CKMC22*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MC2) + (MC2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MC2*A0(G&
 ...
 amplitudes(9) = (0.015625D0*CKM31*CKMC32*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MT2) + (MT2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MT2*A0(G&
 ...
 SelfDSLeftUsual = totalAmplitude
end function SelfDSLeftUsual
