double complex function SelfG0A0Usual(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(11) = (-0.09375D0*EL2*MC2*(2.D0*A0(MC2) - 1.D0*x*B0(x, MC2, MC2)))/(MW2*PI2*SW2*TB)

 amplitudes(12) = (-0.09375D0*EL2*MT2*(2.D0*A0(MT2) - 1.D0*x*B0(x, MT2, MT2)))/(MW2*PI2*SW2*TB)

 amplitudes(13) = (0.09375D0*EL2*MD2*Yuk3*(2.D0*A0(MD2) - 1.D0*x*B0(x, MD2, MD2)))/(MW2*PI2*SW2)

 amplitudes(14) = (0.09375D0*EL2*MS2*Yuk3*(2.D0*A0(MS2) - 1.D0*x*B0(x, MS2, MS2)))/(MW2*PI2*SW2)

 amplitudes(15) = (0.09375D0*EL2*MB2*Yuk3*(2.D0*A0(MB2) - 1.D0*x*B0(x, MB2, MB2)))/(MW2*PI2*SW2)
 ...
 amplitudes(18) = (0.015625D0*CBA*EL2*Mh02*(-1.D0*MA02 + Mh02)*SBA*B0(x, Mh02, GaugeXiZ*MZ2))/(MW2*PI2*SW2)

 amplitudes(19) = (0.015625D0*CBA*EL2*(MA02 - 1.D0*MHH2)*MHH2*SBA*B0(x, MHH2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)

 amplitudes(20) = (0.015625D0*CBA*EL2*SBA*(MZ2*A0(Mh02) + (Mh02 - 1.D0*MZ2 - 1.D0*x)*A0(MZ2) - 1.D0*Mh02*A0(GaugeXiZ*MZ2) - 1.D0*&
 ...
 amplitudes(21) = (0.015625D0*CBA*EL2*SBA*(-1.D0*MZ2*A0(MHH2) + (-1.D0*MHH2 + MZ2 + x)*A0(MZ2) + MHH2*A0(GaugeXiZ*MZ2) + GaugeXiZ&
 ...
 SelfG0A0Usual = totalAmplitude
end function SelfG0A0Usual
