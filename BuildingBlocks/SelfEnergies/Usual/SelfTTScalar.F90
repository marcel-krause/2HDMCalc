...
#include "looptools.h"
 ...
 amplitudes(1) = (0.015625D0*CA2*EL2*MT2*B0(x, Mh02, MT2))/(MW2*PI2*SB2*SW2)

 amplitudes(2) = (0.015625D0*EL2*MT2*SA2*B0(x, MHH2, MT2))/(MW2*PI2*SB2*SW2)
 ...
 amplitudes(6) = (0.03125D0*CKM32*CKMC32*EL2*MS2*Yuk3*B0(x, MHp2, MS2))/(MW2*PI2*SW2*TB)
