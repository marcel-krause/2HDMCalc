double complex function SelfTauTauRightUsual(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(7) = (0.03125D0*EL2*(-2.D0*x - 2.D0*A0(ML2) + ML2*B0(x, 0.D0, ML2) + GaugeXiA*ML2*B0(x, 0.D0, ML2) + x*B0(x, 0.D0, ML&
 ...
 amplitudes(8) = (0.0078125D0*EL2*(-8.D0*MZ2*x*DBLE(SW**INT(4.D0)) - 8.D0*MZ2*A0(ML2)*DBLE(SW**INT(4.D0)) + 4.D0*ML2*A0(MZ2)*DBLE&
 ...
 SelfTauTauRightUsual = totalAmplitude
end function SelfTauTauRightUsual
