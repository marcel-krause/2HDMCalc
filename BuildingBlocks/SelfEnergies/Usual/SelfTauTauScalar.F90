...
#include "looptools.h"
 ...
 amplitudes(7) = (-0.0625D0*EL2*(-2.D0 + (3.D0 + GaugeXiA)*B0(x, 0.D0, ML2)))/PI2

 amplitudes(8) = (-0.03125D0*EL2*(-1.D0 + 2.D0*SW2)*(-2.D0 + 3.D0*B0(x, ML2, MZ2) + GaugeXiZ*B0(x, ML2, GaugeXiZ*MZ2)))/(CW2*PI2)
