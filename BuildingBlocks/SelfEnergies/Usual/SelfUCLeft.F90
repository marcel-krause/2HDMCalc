double complex function SelfUCLeftUsual(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(1) = (0.015625D0*CKM21*CKMC11*EL2*(-1.D0*MD2*TB2*A0(MD2)*DBLE(Yuk3**INT(2.D0)) + MD2*TB2*A0(MHp2)*DBLE(Yuk3**INT(2.D0&
 ...
 amplitudes(2) = (0.015625D0*CKM22*CKMC12*EL2*(MS2*TB2*A0(MHp2)*DBLE(Yuk3**INT(2.D0)) - 1.D0*MS2*TB2*A0(MS2)*DBLE(Yuk3**INT(2.D0)&
 ...
 amplitudes(3) = (0.015625D0*CKM23*CKMC13*EL2*(-1.D0*MB2*TB2*A0(MB2)*DBLE(Yuk3**INT(2.D0)) + MB2*TB2*A0(MHp2)*DBLE(Yuk3**INT(2.D0&
 ...
 amplitudes(4) = (0.015625D0*CKM21*CKMC11*EL2*(-1.D0*MD2*A0(MD2) + MD2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MD2*MW2*B0(x, MD2, GaugeX&
  &iW*MW2) + MD2*x*B0(x, MD2, GaugeXiW*MW2) + B0(x, MD2, GaugeXiW*MW2)*DBLE(MD**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(5) = (0.015625D0*CKM22*CKMC12*EL2*(-1.D0*MS2*A0(MS2) + MS2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MS2*MW2*B0(x, MS2, GaugeX&
  &iW*MW2) + MS2*x*B0(x, MS2, GaugeXiW*MW2) + B0(x, MS2, GaugeXiW*MW2)*DBLE(MS**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(6) = (0.015625D0*CKM23*CKMC13*EL2*(-1.D0*MB2*A0(MB2) + MB2*A0(GaugeXiW*MW2) - 1.D0*GaugeXiW*MB2*MW2*B0(x, MB2, GaugeX&
  &iW*MW2) + MB2*x*B0(x, MB2, GaugeXiW*MW2) + B0(x, MB2, GaugeXiW*MW2)*DBLE(MB**INT(4.D0))))/(MW2*PI2*SW2*x)

 amplitudes(7) = (0.015625D0*CKM21*CKMC11*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MD2) + (MD2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MD2*A0(G&
 ...
 amplitudes(8) = (0.015625D0*CKM22*CKMC12*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MS2) + (MS2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MS2*A0(G&
 ...
 amplitudes(9) = (0.015625D0*CKM23*CKMC13*EL2*(-2.D0*MW2*x - 2.D0*MW2*A0(MB2) + (MB2 + 2.D0*MW2 - 1.D0*x)*A0(MW2) - 1.D0*MB2*A0(G&
 ...
 SelfUCLeftUsual = totalAmplitude
end function SelfUCLeftUsual
