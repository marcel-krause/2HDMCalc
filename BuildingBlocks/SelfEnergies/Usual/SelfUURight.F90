...
#include "looptools.h"
 ...
 amplitudes(5) = (0.015625D0*CKM11*CKMC11*EL2*(-1.D0*MU2*A0(MD2) + MU2*A0(MHp2) + MD2*MU2*B0(x, MD2, MHp2) - 1.D0*MHp2*MU2*B0(x, &
  &MD2, MHp2) + MU2*x*B0(x, MD2, MHp2)))/(MW2*PI2*SW2*TB2*x)

 amplitudes(6) = (0.015625D0*CKM12*CKMC12*EL2*(MU2*A0(MHp2) - 1.D0*MU2*A0(MS2) - 1.D0*MHp2*MU2*B0(x, MHp2, MS2) + MS2*MU2*B0(x, M&
  &Hp2, MS2) + MU2*x*B0(x, MHp2, MS2)))/(MW2*PI2*SW2*TB2*x)

 amplitudes(7) = (0.015625D0*CKM13*CKMC13*EL2*(-1.D0*MU2*A0(MB2) + MU2*A0(MHp2) + MB2*MU2*B0(x, MB2, MHp2) - 1.D0*MHp2*MU2*B0(x, &
  &MB2, MHp2) + MU2*x*B0(x, MB2, MHp2)))/(MW2*PI2*SW2*TB2*x)

 amplitudes(8) = (0.015625D0*CKM11*CKMC11*EL2*(-1.D0*MU2*A0(MD2) + MU2*A0(GaugeXiW*MW2) + MD2*MU2*B0(x, MD2, GaugeXiW*MW2) - 1.D0&
  &*GaugeXiW*MU2*MW2*B0(x, MD2, GaugeXiW*MW2) + MU2*x*B0(x, MD2, GaugeXiW*MW2)))/(MW2*PI2*SW2*x)

 amplitudes(9) = (0.015625D0*CKM12*CKMC12*EL2*(-1.D0*MU2*A0(MS2) + MU2*A0(GaugeXiW*MW2) + MS2*MU2*B0(x, MS2, GaugeXiW*MW2) - 1.D0&
  &*GaugeXiW*MU2*MW2*B0(x, MS2, GaugeXiW*MW2) + MU2*x*B0(x, MS2, GaugeXiW*MW2)))/(MW2*PI2*SW2*x)

 amplitudes(10) = (0.015625D0*CKM13*CKMC13*EL2*(-1.D0*MU2*A0(MB2) + MU2*A0(GaugeXiW*MW2) + MB2*MU2*B0(x, MB2, GaugeXiW*MW2) - 1.D&
  &0*GaugeXiW*MU2*MW2*B0(x, MB2, GaugeXiW*MW2) + MU2*x*B0(x, MB2, GaugeXiW*MW2)))/(MW2*PI2*SW2*x)
 ...
 amplitudes(12) = (0.0008680555555555555D0*EL2*(-32.D0*MZ2*x*DBLE(SW**INT(4.D0)) - 32.D0*MZ2*A0(MU2)*DBLE(SW**INT(4.D0)) + 16.D0*&
  &MU2*A0(MZ2)*DBLE(SW**INT(4.D0)) + 32.D0*MZ2*A0(MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*x*A0(MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*MU2*A0(G&
  &augeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*x*A0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MU2*MZ2*B0(x, MU2, MZ2)*DBLE(SW**INT(4&
  &.D0)) - 32.D0*MU2*x*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MZ2*x*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*MU2&
  &*MZ2*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 32.D0*MU2*x*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*&
  ...
  &+ 16.D0*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0)) - 16.D0*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**IN&
