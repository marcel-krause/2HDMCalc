...
#include "looptools.h"
 ...
 amplitudes(4) = (-0.015625D0*EL2*MU2*B0(x, MU2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(8) = (-0.03125D0*CKM11*CKMC11*EL2*MD2*B0(x, MD2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(9) = (-0.03125D0*CKM12*CKMC12*EL2*MS2*B0(x, MS2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(10) = (-0.03125D0*CKM13*CKMC13*EL2*MB2*B0(x, MB2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(11) = (-0.027777777777777776D0*EL2*(-2.D0 + (3.D0 + GaugeXiA)*B0(x, 0.D0, MU2)))/PI2

 amplitudes(12) = (-0.006944444444444444D0*EL2*(-3.D0 + 4.D0*SW2)*(-2.D0 + 3.D0*B0(x, MU2, MZ2) + GaugeXiZ*B0(x, MU2, GaugeXiZ*MZ&
  &2)))/(CW2*PI2)
