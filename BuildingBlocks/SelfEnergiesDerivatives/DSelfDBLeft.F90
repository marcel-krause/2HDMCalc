double complex function DSelfDBLeft(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(1) = (0.015625D0*CKM11*CKMC13*EL2*(MU2*B0(x, MHp2, MU2) - 1.D0*MHp2*MU2*DB0(x, MHp2, MU2) + MU2*x*DB0(x, MHp2, MU2) +&
  & DB0(x, MHp2, MU2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*TB2*x) - (0.015625D0*CKM11*CKMC13*EL2*(MU2*A0(MHp2) - 1.D0*MU2*A0(MU2) -&
  & 1.D0*MHp2*MU2*B0(x, MHp2, MU2) + MU2*x*B0(x, MHp2, MU2) + B0(x, MHp2, MU2)*DBLE(MU**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2&
  &*SW2*TB2)

 amplitudes(2) = (0.015625D0*CKM21*CKMC23*EL2*(MC2*B0(x, MC2, MHp2) - 1.D0*MC2*MHp2*DB0(x, MC2, MHp2) + MC2*x*DB0(x, MC2, MHp2) +&
  & DB0(x, MC2, MHp2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*TB2*x) - (0.015625D0*CKM21*CKMC23*EL2*(-1.D0*MC2*A0(MC2) + MC2*A0(MHp2) &
  &- 1.D0*MC2*MHp2*B0(x, MC2, MHp2) + MC2*x*B0(x, MC2, MHp2) + B0(x, MC2, MHp2)*DBLE(MC**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI&
  &2*SW2*TB2)

 amplitudes(3) = (0.015625D0*CKM31*CKMC33*EL2*(MT2*B0(x, MHp2, MT2) - 1.D0*MHp2*MT2*DB0(x, MHp2, MT2) + MT2*x*DB0(x, MHp2, MT2) +&
  & DB0(x, MHp2, MT2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*TB2*x) - (0.015625D0*CKM31*CKMC33*EL2*(MT2*A0(MHp2) - 1.D0*MT2*A0(MT2) -&
  & 1.D0*MHp2*MT2*B0(x, MHp2, MT2) + MT2*x*B0(x, MHp2, MT2) + B0(x, MHp2, MT2)*DBLE(MT**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2&
  &*SW2*TB2)

 amplitudes(4) = (0.015625D0*CKM11*CKMC13*EL2*(MU2*B0(x, MU2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MU2*MW2*DB0(x, MU2, GaugeXiW*MW2) + M&
  &U2*x*DB0(x, MU2, GaugeXiW*MW2) + DB0(x, MU2, GaugeXiW*MW2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM11*CKMC13*EL&
 ...
 amplitudes(5) = (0.015625D0*CKM21*CKMC23*EL2*(MC2*B0(x, MC2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MC2*MW2*DB0(x, MC2, GaugeXiW*MW2) + M&
  &C2*x*DB0(x, MC2, GaugeXiW*MW2) + DB0(x, MC2, GaugeXiW*MW2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM21*CKMC23*EL&
 ...
 amplitudes(6) = (0.015625D0*CKM31*CKMC33*EL2*(MT2*B0(x, MT2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MT2*MW2*DB0(x, MT2, GaugeXiW*MW2) + M&
  &T2*x*DB0(x, MT2, GaugeXiW*MW2) + DB0(x, MT2, GaugeXiW*MW2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM31*CKMC33*EL&
 ...
 amplitudes(7) = (-0.015625D0*CKM11*CKMC13*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MU2) + (MU2 + 2.D0*MW2 - 1.D0*x)*A0&
  ...
  &25D0*CKM11*CKMC13*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MU2*B0(x, MU2, MW2) + MW2*B0(x, MU2, MW2) + 2.D0*x*B&
 ...
 amplitudes(8) = (-0.015625D0*CKM21*CKMC23*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MC2) + (MC2 + 2.D0*MW2 - 1.D0*x)*A0&
  ...
  &25D0*CKM21*CKMC23*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MC2*B0(x, MC2, MW2) + MW2*B0(x, MC2, MW2) + 2.D0*x*B&
 ...
 amplitudes(9) = (-0.015625D0*CKM31*CKMC33*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MT2) + (MT2 + 2.D0*MW2 - 1.D0*x)*A0&
  ...
  &25D0*CKM31*CKMC33*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MT2*B0(x, MT2, MW2) + MW2*B0(x, MT2, MW2) + 2.D0*x*B&
 ...
 DSelfDBLeft = totalAmplitude
end function DSelfDBLeft
