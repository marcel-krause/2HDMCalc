double complex function DSelfDBScalar(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(1) = (0.03125D0*CKM11*CKMC13*EL2*MU2*Yuk3*DB0(x, MHp2, MU2))/(MW2*PI2*SW2*TB)

 amplitudes(2) = (0.03125D0*CKM21*CKMC23*EL2*MC2*Yuk3*DB0(x, MC2, MHp2))/(MW2*PI2*SW2*TB)
 ...
 DSelfDBScalar = totalAmplitude
end function DSelfDBScalar
