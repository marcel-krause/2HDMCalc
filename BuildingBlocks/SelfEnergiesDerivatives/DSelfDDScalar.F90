...
#include "looptools.h"
 ...
 amplitudes(4) = (-0.015625D0*EL2*MD2*DB0(x, MD2, GaugeXiZ*MZ2))/(MW2*PI2*SW2)
 ...
 amplitudes(8) = (-0.03125D0*CKM11*CKMC11*EL2*MU2*DB0(x, MU2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(9) = (-0.03125D0*CKM21*CKMC21*EL2*MC2*DB0(x, MC2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(10) = (-0.03125D0*CKM31*CKMC31*EL2*MT2*DB0(x, MT2, GaugeXiW*MW2))/(MW2*PI2*SW2)

 amplitudes(11) = (-0.006944444444444444D0*EL2*(3.D0 + GaugeXiA)*DB0(x, 0.D0, MD2))/PI2

 amplitudes(12) = (-0.003472222222222222D0*EL2*(-3.D0 + 2.D0*SW2)*(3.D0*DB0(x, MD2, MZ2) + GaugeXiZ*DB0(x, MD2, GaugeXiZ*MZ2)))/(&
  &CW2*PI2)
