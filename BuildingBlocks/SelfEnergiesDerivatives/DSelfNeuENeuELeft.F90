...
#include "looptools.h"
 ...
 amplitudes(2) = (-0.03125D0*EL2*ME2*DB1(x, ME2, GaugeXiW*MW2))/(MW2*PI2*SW2)
 ...
 amplitudes(4) = (-0.03125D0*EL2*(-1.D0*B0(x, ME2, MW2) + B0(x, ME2, GaugeXiW*MW2) - 1.D0*B1(x, ME2, MW2) + B1(x, ME2, GaugeXiW*M&
  &W2) + (ME2 + MW2 - 1.D0*x)*DB0(x, ME2, MW2) - 1.D0*(ME2 + GaugeXiW*MW2 - 1.D0*x)*DB0(x, ME2, GaugeXiW*MW2) + ME2*DB1(x, ME2, M&
  &W2) + 2.D0*MW2*DB1(x, ME2, MW2) - 1.D0*x*DB1(x, ME2, MW2) - 1.D0*ME2*DB1(x, ME2, GaugeXiW*MW2) + x*DB1(x, ME2, GaugeXiW*MW2)))&
  &/(MW2*PI2*SW2)
