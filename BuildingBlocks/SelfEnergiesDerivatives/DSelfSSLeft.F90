double complex function DSelfSSLeft(x)
 use constants
 implicit none
#include "looptools.h"
 ...
 amplitudes(5) = (0.015625D0*CKM12*CKMC12*EL2*(MU2*B0(x, MHp2, MU2) - 1.D0*MHp2*MU2*DB0(x, MHp2, MU2) + MU2*x*DB0(x, MHp2, MU2) +&
  & DB0(x, MHp2, MU2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*TB2*x) - (0.015625D0*CKM12*CKMC12*EL2*(MU2*A0(MHp2) - 1.D0*MU2*A0(MU2) -&
  & 1.D0*MHp2*MU2*B0(x, MHp2, MU2) + MU2*x*B0(x, MHp2, MU2) + B0(x, MHp2, MU2)*DBLE(MU**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2&
  &*SW2*TB2)

 amplitudes(6) = (0.015625D0*CKM22*CKMC22*EL2*(MC2*B0(x, MC2, MHp2) - 1.D0*MC2*MHp2*DB0(x, MC2, MHp2) + MC2*x*DB0(x, MC2, MHp2) +&
  & DB0(x, MC2, MHp2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*TB2*x) - (0.015625D0*CKM22*CKMC22*EL2*(-1.D0*MC2*A0(MC2) + MC2*A0(MHp2) &
  &- 1.D0*MC2*MHp2*B0(x, MC2, MHp2) + MC2*x*B0(x, MC2, MHp2) + B0(x, MC2, MHp2)*DBLE(MC**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI&
  &2*SW2*TB2)

 amplitudes(7) = (0.015625D0*CKM32*CKMC32*EL2*(MT2*B0(x, MHp2, MT2) - 1.D0*MHp2*MT2*DB0(x, MHp2, MT2) + MT2*x*DB0(x, MHp2, MT2) +&
  & DB0(x, MHp2, MT2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*TB2*x) - (0.015625D0*CKM32*CKMC32*EL2*(MT2*A0(MHp2) - 1.D0*MT2*A0(MT2) -&
  & 1.D0*MHp2*MT2*B0(x, MHp2, MT2) + MT2*x*B0(x, MHp2, MT2) + B0(x, MHp2, MT2)*DBLE(MT**INT(4.D0)))*DBLE(x**INT(-2.D0)))/(MW2*PI2&
  &*SW2*TB2)

 amplitudes(8) = (0.015625D0*CKM12*CKMC12*EL2*(MU2*B0(x, MU2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MU2*MW2*DB0(x, MU2, GaugeXiW*MW2) + M&
  &U2*x*DB0(x, MU2, GaugeXiW*MW2) + DB0(x, MU2, GaugeXiW*MW2)*DBLE(MU**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM12*CKMC12*EL&
 ...
 amplitudes(9) = (0.015625D0*CKM22*CKMC22*EL2*(MC2*B0(x, MC2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MC2*MW2*DB0(x, MC2, GaugeXiW*MW2) + M&
  &C2*x*DB0(x, MC2, GaugeXiW*MW2) + DB0(x, MC2, GaugeXiW*MW2)*DBLE(MC**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM22*CKMC22*EL&
 ...
 amplitudes(10) = (0.015625D0*CKM32*CKMC32*EL2*(MT2*B0(x, MT2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MT2*MW2*DB0(x, MT2, GaugeXiW*MW2) + &
  &MT2*x*DB0(x, MT2, GaugeXiW*MW2) + DB0(x, MT2, GaugeXiW*MW2)*DBLE(MT**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM32*CKMC32*E&
 ...
 amplitudes(12) = (-0.0008680555555555555D0*EL2*DBLE(x**INT(-2.D0))*(-18.D0*MZ2*x + 24.D0*MZ2*SW2*x - 18.D0*MZ2*A0(MS2) + 24.D0*M&
  &Z2*SW2*A0(MS2) + 9.D0*MS2*A0(MZ2) + 18.D0*MZ2*A0(MZ2) - 12.D0*MS2*SW2*A0(MZ2) - 24.D0*MZ2*SW2*A0(MZ2) - 9.D0*x*A0(MZ2) + 12.D0&
  &*SW2*x*A0(MZ2) - 9.D0*MS2*A0(GaugeXiZ*MZ2) + 12.D0*MS2*SW2*A0(GaugeXiZ*MZ2) + 9.D0*x*A0(GaugeXiZ*MZ2) - 12.D0*SW2*x*A0(GaugeXi&
  &Z*MZ2) + 9.D0*MS2*MZ2*B0(x, MS2, MZ2) - 12.D0*MS2*MZ2*SW2*B0(x, MS2, MZ2) - 18.D0*MS2*x*B0(x, MS2, MZ2) + 9.D0*MZ2*x*B0(x, MS2&
  &, MZ2) + 24.D0*MS2*SW2*x*B0(x, MS2, MZ2) - 12.D0*MZ2*SW2*x*B0(x, MS2, MZ2) + 9.D0*GaugeXiZ*MS2*MZ2*B0(x, MS2, GaugeXiZ*MZ2) - &
  &12.D0*GaugeXiZ*MS2*MZ2*SW2*B0(x, MS2, GaugeXiZ*MZ2) + 18.D0*MS2*x*B0(x, MS2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ2*x*B0(x, MS2, Ga&
  &ugeXiZ*MZ2) - 24.D0*MS2*SW2*x*B0(x, MS2, GaugeXiZ*MZ2) - 12.D0*GaugeXiZ*MZ2*SW2*x*B0(x, MS2, GaugeXiZ*MZ2) + 9.D0*B0(x, MS2, M&
  &Z2)*DBLE(MS**INT(4.D0)) - 12.D0*SW2*B0(x, MS2, MZ2)*DBLE(MS**INT(4.D0)) - 9.D0*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(MS**INT(4.D0)) + &
  &12.D0*SW2*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(MS**INT(4.D0)) - 18.D0*B0(x, MS2, MZ2)*DBLE(MZ**INT(4.D0)) + 24.D0*SW2*B0(x, MS2, MZ2)&
  &*DBLE(MZ**INT(4.D0)) - 8.D0*MZ2*x*DBLE(SW**INT(4.D0)) - 8.D0*MZ2*A0(MS2)*DBLE(SW**INT(4.D0)) + 4.D0*MS2*A0(MZ2)*DBLE(SW**INT(4&
  &.D0)) + 8.D0*MZ2*A0(MZ2)*DBLE(SW**INT(4.D0)) - 4.D0*x*A0(MZ2)*DBLE(SW**INT(4.D0)) - 4.D0*MS2*A0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D&
  &0)) + 4.D0*x*A0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MS2*MZ2*B0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) - 8.D0*MS2*x*B0(x, MS2, M&
  &Z2)*DBLE(SW**INT(4.D0)) + 4.D0*MZ2*x*B0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MS2*MZ2*B0(x, MS2, GaugeXiZ*MZ2)*DBLE&
  &(SW**INT(4.D0)) + 8.D0*MS2*x*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MZ2*x*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(&
  &SW**INT(4.D0)) + 4.D0*B0(x, MS2, MZ2)*DBLE(MS**INT(4.D0))*DBLE(SW**INT(4.D0)) - 4.D0*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(MS**INT(4.D&
  &0))*DBLE(SW**INT(4.D0)) - 8.D0*B0(x, MS2, MZ2)*DBLE(MZ**INT(4.D0))*DBLE(SW**INT(4.D0)) + 9.D0*B0(x, MS2, MZ2)*DBLE(x**INT(2.D0&
  &)) - 12.D0*SW2*B0(x, MS2, MZ2)*DBLE(x**INT(2.D0)) - 9.D0*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 12.D0*SW2*B0(x, MS2, Ga&
  &ugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 4.D0*B0(x, MS2, MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0)) - 4.D0*B0(x, MS2, GaugeXiZ*MZ2)*D&
  &BLE(SW**INT(4.D0))*DBLE(x**INT(2.D0))))/(CW2*MZ2*PI2*SW2) + (0.0008680555555555555D0*EL2*(-18.D0*MZ2 + 24.D0*MZ2*SW2 - 9.D0*A0&
  &(MZ2) + 12.D0*SW2*A0(MZ2) + 9.D0*A0(GaugeXiZ*MZ2) - 12.D0*SW2*A0(GaugeXiZ*MZ2) - 18.D0*MS2*B0(x, MS2, MZ2) + 9.D0*MZ2*B0(x, MS&
  &2, MZ2) + 24.D0*MS2*SW2*B0(x, MS2, MZ2) - 12.D0*MZ2*SW2*B0(x, MS2, MZ2) + 18.D0*x*B0(x, MS2, MZ2) - 24.D0*SW2*x*B0(x, MS2, MZ2&
  &) + 18.D0*MS2*B0(x, MS2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ2*B0(x, MS2, GaugeXiZ*MZ2) - 24.D0*MS2*SW2*B0(x, MS2, GaugeXiZ*MZ2) -&
  & 12.D0*GaugeXiZ*MZ2*SW2*B0(x, MS2, GaugeXiZ*MZ2) - 18.D0*x*B0(x, MS2, GaugeXiZ*MZ2) + 24.D0*SW2*x*B0(x, MS2, GaugeXiZ*MZ2) + 9&
  &.D0*MS2*MZ2*DB0(x, MS2, MZ2) - 12.D0*MS2*MZ2*SW2*DB0(x, MS2, MZ2) - 18.D0*MS2*x*DB0(x, MS2, MZ2) + 9.D0*MZ2*x*DB0(x, MS2, MZ2)&
  & + 24.D0*MS2*SW2*x*DB0(x, MS2, MZ2) - 12.D0*MZ2*SW2*x*DB0(x, MS2, MZ2) + 9.D0*GaugeXiZ*MS2*MZ2*DB0(x, MS2, GaugeXiZ*MZ2) - 12.&
  &D0*GaugeXiZ*MS2*MZ2*SW2*DB0(x, MS2, GaugeXiZ*MZ2) + 18.D0*MS2*x*DB0(x, MS2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ2*x*DB0(x, MS2, Ga&
  &ugeXiZ*MZ2) - 24.D0*MS2*SW2*x*DB0(x, MS2, GaugeXiZ*MZ2) - 12.D0*GaugeXiZ*MZ2*SW2*x*DB0(x, MS2, GaugeXiZ*MZ2) + 9.D0*DB0(x, MS2&
  &, MZ2)*DBLE(MS**INT(4.D0)) - 12.D0*SW2*DB0(x, MS2, MZ2)*DBLE(MS**INT(4.D0)) - 9.D0*DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(MS**INT(4.D0&
  &)) + 12.D0*SW2*DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(MS**INT(4.D0)) - 18.D0*DB0(x, MS2, MZ2)*DBLE(MZ**INT(4.D0)) + 24.D0*SW2*DB0(x, M&
  &S2, MZ2)*DBLE(MZ**INT(4.D0)) - 8.D0*MZ2*DBLE(SW**INT(4.D0)) - 4.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*A0(GaugeXiZ*MZ2)*DBLE(SW&
  &**INT(4.D0)) - 8.D0*MS2*B0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MZ2*B0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) + 8.D0*x*B0(x, MS2,&
  & MZ2)*DBLE(SW**INT(4.D0)) + 8.D0*MS2*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MZ2*B0(x, MS2, GaugeXiZ*MZ2)&
  &*DBLE(SW**INT(4.D0)) - 8.D0*x*B0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MS2*MZ2*DB0(x, MS2, MZ2)*DBLE(SW**INT(4.D0))&
  & - 8.D0*MS2*x*DB0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*MZ2*x*DB0(x, MS2, MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MS2*MZ2*D&
  &B0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 8.D0*MS2*x*DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*GaugeXiZ*MZ2*x*&
  &DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 4.D0*DB0(x, MS2, MZ2)*DBLE(MS**INT(4.D0))*DBLE(SW**INT(4.D0)) - 4.D0*DB0(x, MS&
  &2, GaugeXiZ*MZ2)*DBLE(MS**INT(4.D0))*DBLE(SW**INT(4.D0)) - 8.D0*DB0(x, MS2, MZ2)*DBLE(MZ**INT(4.D0))*DBLE(SW**INT(4.D0)) + 9.D&
  &0*DB0(x, MS2, MZ2)*DBLE(x**INT(2.D0)) - 12.D0*SW2*DB0(x, MS2, MZ2)*DBLE(x**INT(2.D0)) - 9.D0*DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(x*&
  &*INT(2.D0)) + 12.D0*SW2*DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 4.D0*DB0(x, MS2, MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2&
  &.D0)) - 4.D0*DB0(x, MS2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0))))/(CW2*MZ2*PI2*SW2*x)

 amplitudes(13) = (-0.015625D0*CKM12*CKMC12*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MU2) + (MU2 + 2.D0*MW2 - 1.D0*x)*A&
  ...
  &625D0*CKM12*CKMC12*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MU2*B0(x, MU2, MW2) + MW2*B0(x, MU2, MW2) + 2.D0*x*&
 ...
 amplitudes(14) = (-0.015625D0*CKM22*CKMC22*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MC2) + (MC2 + 2.D0*MW2 - 1.D0*x)*A&
  ...
  &625D0*CKM22*CKMC22*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MC2*B0(x, MC2, MW2) + MW2*B0(x, MC2, MW2) + 2.D0*x*&
 ...
 amplitudes(15) = (-0.015625D0*CKM32*CKMC32*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MT2) + (MT2 + 2.D0*MW2 - 1.D0*x)*A&
  ...
  &625D0*CKM32*CKMC32*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MT2*B0(x, MT2, MW2) + MW2*B0(x, MT2, MW2) + 2.D0*x*&
 ...
 DSelfSSLeft = totalAmplitude
end function DSelfSSLeft
