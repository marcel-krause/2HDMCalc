...
#include "looptools.h"
 ...
 amplitudes(5) = (-0.015625D0*CKM11*CKMC11*EL2*DBLE(x**INT(-2.D0))*(-1.D0*MD2*TB2*A0(MD2)*DBLE(Yuk3**INT(2.D0)) + MD2*TB2*A0(MHp2&
  &)*DBLE(Yuk3**INT(2.D0)) - 1.D0*MD2*MHp2*TB2*B0(x, MD2, MHp2)*DBLE(Yuk3**INT(2.D0)) + MD2*TB2*x*B0(x, MD2, MHp2)*DBLE(Yuk3**INT&
  &(2.D0)) + TB2*B0(x, MD2, MHp2)*DBLE(MD**INT(4.D0))*DBLE(Yuk3**INT(2.D0))))/(MW2*PI2*SW2*TB2) + (0.015625D0*CKM11*CKMC11*EL2*(M&
 ...
 amplitudes(6) = (-0.015625D0*CKM12*CKMC12*EL2*DBLE(x**INT(-2.D0))*(MS2*TB2*A0(MHp2)*DBLE(Yuk3**INT(2.D0)) - 1.D0*MS2*TB2*A0(MS2)&
  &*DBLE(Yuk3**INT(2.D0)) - 1.D0*MHp2*MS2*TB2*B0(x, MHp2, MS2)*DBLE(Yuk3**INT(2.D0)) + MS2*TB2*x*B0(x, MHp2, MS2)*DBLE(Yuk3**INT(&
  &2.D0)) + TB2*B0(x, MHp2, MS2)*DBLE(MS**INT(4.D0))*DBLE(Yuk3**INT(2.D0))))/(MW2*PI2*SW2*TB2) + (0.015625D0*CKM12*CKMC12*EL2*(MS&
 ...
 amplitudes(7) = (-0.015625D0*CKM13*CKMC13*EL2*DBLE(x**INT(-2.D0))*(-1.D0*MB2*TB2*A0(MB2)*DBLE(Yuk3**INT(2.D0)) + MB2*TB2*A0(MHp2&
  &)*DBLE(Yuk3**INT(2.D0)) - 1.D0*MB2*MHp2*TB2*B0(x, MB2, MHp2)*DBLE(Yuk3**INT(2.D0)) + MB2*TB2*x*B0(x, MB2, MHp2)*DBLE(Yuk3**INT&
  &(2.D0)) + TB2*B0(x, MB2, MHp2)*DBLE(MB**INT(4.D0))*DBLE(Yuk3**INT(2.D0))))/(MW2*PI2*SW2*TB2) + (0.015625D0*CKM13*CKMC13*EL2*(M&
 ...
 amplitudes(8) = (0.015625D0*CKM11*CKMC11*EL2*(MD2*B0(x, MD2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MD2*MW2*DB0(x, MD2, GaugeXiW*MW2) + M&
  &D2*x*DB0(x, MD2, GaugeXiW*MW2) + DB0(x, MD2, GaugeXiW*MW2)*DBLE(MD**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM11*CKMC11*EL&
 ...
 amplitudes(9) = (0.015625D0*CKM12*CKMC12*EL2*(MS2*B0(x, MS2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MS2*MW2*DB0(x, MS2, GaugeXiW*MW2) + M&
  &S2*x*DB0(x, MS2, GaugeXiW*MW2) + DB0(x, MS2, GaugeXiW*MW2)*DBLE(MS**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM12*CKMC12*EL&
 ...
 amplitudes(10) = (0.015625D0*CKM13*CKMC13*EL2*(MB2*B0(x, MB2, GaugeXiW*MW2) - 1.D0*GaugeXiW*MB2*MW2*DB0(x, MB2, GaugeXiW*MW2) + &
  &MB2*x*DB0(x, MB2, GaugeXiW*MW2) + DB0(x, MB2, GaugeXiW*MW2)*DBLE(MB**INT(4.D0))))/(MW2*PI2*SW2*x) - (0.015625D0*CKM13*CKMC13*E&
 ...
 amplitudes(12) = (-0.0008680555555555555D0*EL2*DBLE(x**INT(-2.D0))*(-18.D0*MZ2*x + 48.D0*MZ2*SW2*x - 18.D0*MZ2*A0(MU2) + 48.D0*M&
  &Z2*SW2*A0(MU2) + 9.D0*MU2*A0(MZ2) + 18.D0*MZ2*A0(MZ2) - 24.D0*MU2*SW2*A0(MZ2) - 48.D0*MZ2*SW2*A0(MZ2) - 9.D0*x*A0(MZ2) + 24.D0&
  &*SW2*x*A0(MZ2) - 9.D0*MU2*A0(GaugeXiZ*MZ2) + 24.D0*MU2*SW2*A0(GaugeXiZ*MZ2) + 9.D0*x*A0(GaugeXiZ*MZ2) - 24.D0*SW2*x*A0(GaugeXi&
  &Z*MZ2) + 9.D0*MU2*MZ2*B0(x, MU2, MZ2) - 24.D0*MU2*MZ2*SW2*B0(x, MU2, MZ2) - 18.D0*MU2*x*B0(x, MU2, MZ2) + 9.D0*MZ2*x*B0(x, MU2&
  &, MZ2) + 48.D0*MU2*SW2*x*B0(x, MU2, MZ2) - 24.D0*MZ2*SW2*x*B0(x, MU2, MZ2) + 9.D0*GaugeXiZ*MU2*MZ2*B0(x, MU2, GaugeXiZ*MZ2) - &
  &24.D0*GaugeXiZ*MU2*MZ2*SW2*B0(x, MU2, GaugeXiZ*MZ2) + 18.D0*MU2*x*B0(x, MU2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ2*x*B0(x, MU2, Ga&
  &ugeXiZ*MZ2) - 48.D0*MU2*SW2*x*B0(x, MU2, GaugeXiZ*MZ2) - 24.D0*GaugeXiZ*MZ2*SW2*x*B0(x, MU2, GaugeXiZ*MZ2) + 9.D0*B0(x, MU2, M&
  &Z2)*DBLE(MU**INT(4.D0)) - 24.D0*SW2*B0(x, MU2, MZ2)*DBLE(MU**INT(4.D0)) - 9.D0*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(MU**INT(4.D0)) + &
  &24.D0*SW2*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(MU**INT(4.D0)) - 18.D0*B0(x, MU2, MZ2)*DBLE(MZ**INT(4.D0)) + 48.D0*SW2*B0(x, MU2, MZ2)&
  &*DBLE(MZ**INT(4.D0)) - 32.D0*MZ2*x*DBLE(SW**INT(4.D0)) - 32.D0*MZ2*A0(MU2)*DBLE(SW**INT(4.D0)) + 16.D0*MU2*A0(MZ2)*DBLE(SW**IN&
  &T(4.D0)) + 32.D0*MZ2*A0(MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*x*A0(MZ2)*DBLE(SW**INT(4.D0)) - 16.D0*MU2*A0(GaugeXiZ*MZ2)*DBLE(SW**I&
  &NT(4.D0)) + 16.D0*x*A0(GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MU2*MZ2*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) - 32.D0*MU2*x*B0(&
  &x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MZ2*x*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*MU2*MZ2*B0(x, MU2, GaugeXi&
  &Z*MZ2)*DBLE(SW**INT(4.D0)) + 32.D0*MU2*x*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*MZ2*x*B0(x, MU2, GaugeX&
  &iZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*B0(x, MU2, MZ2)*DBLE(MU**INT(4.D0))*DBLE(SW**INT(4.D0)) - 16.D0*B0(x, MU2, GaugeXiZ*MZ2)*D&
  &BLE(MU**INT(4.D0))*DBLE(SW**INT(4.D0)) - 32.D0*B0(x, MU2, MZ2)*DBLE(MZ**INT(4.D0))*DBLE(SW**INT(4.D0)) + 9.D0*B0(x, MU2, MZ2)*&
  &DBLE(x**INT(2.D0)) - 24.D0*SW2*B0(x, MU2, MZ2)*DBLE(x**INT(2.D0)) - 9.D0*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 24.D0*S&
  &W2*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 16.D0*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0)) - 16.D0*B0(x, MU&
  &2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0))))/(CW2*MZ2*PI2*SW2) + (0.0008680555555555555D0*EL2*(-18.D0*MZ2 + 48.D0&
  &*MZ2*SW2 - 9.D0*A0(MZ2) + 24.D0*SW2*A0(MZ2) + 9.D0*A0(GaugeXiZ*MZ2) - 24.D0*SW2*A0(GaugeXiZ*MZ2) - 18.D0*MU2*B0(x, MU2, MZ2) +&
  & 9.D0*MZ2*B0(x, MU2, MZ2) + 48.D0*MU2*SW2*B0(x, MU2, MZ2) - 24.D0*MZ2*SW2*B0(x, MU2, MZ2) + 18.D0*x*B0(x, MU2, MZ2) - 48.D0*SW&
  &2*x*B0(x, MU2, MZ2) + 18.D0*MU2*B0(x, MU2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ2*B0(x, MU2, GaugeXiZ*MZ2) - 48.D0*MU2*SW2*B0(x, MU&
  &2, GaugeXiZ*MZ2) - 24.D0*GaugeXiZ*MZ2*SW2*B0(x, MU2, GaugeXiZ*MZ2) - 18.D0*x*B0(x, MU2, GaugeXiZ*MZ2) + 48.D0*SW2*x*B0(x, MU2,&
  & GaugeXiZ*MZ2) + 9.D0*MU2*MZ2*DB0(x, MU2, MZ2) - 24.D0*MU2*MZ2*SW2*DB0(x, MU2, MZ2) - 18.D0*MU2*x*DB0(x, MU2, MZ2) + 9.D0*MZ2*&
  &x*DB0(x, MU2, MZ2) + 48.D0*MU2*SW2*x*DB0(x, MU2, MZ2) - 24.D0*MZ2*SW2*x*DB0(x, MU2, MZ2) + 9.D0*GaugeXiZ*MU2*MZ2*DB0(x, MU2, G&
  &augeXiZ*MZ2) - 24.D0*GaugeXiZ*MU2*MZ2*SW2*DB0(x, MU2, GaugeXiZ*MZ2) + 18.D0*MU2*x*DB0(x, MU2, GaugeXiZ*MZ2) + 9.D0*GaugeXiZ*MZ&
  &2*x*DB0(x, MU2, GaugeXiZ*MZ2) - 48.D0*MU2*SW2*x*DB0(x, MU2, GaugeXiZ*MZ2) - 24.D0*GaugeXiZ*MZ2*SW2*x*DB0(x, MU2, GaugeXiZ*MZ2)&
  & + 9.D0*DB0(x, MU2, MZ2)*DBLE(MU**INT(4.D0)) - 24.D0*SW2*DB0(x, MU2, MZ2)*DBLE(MU**INT(4.D0)) - 9.D0*DB0(x, MU2, GaugeXiZ*MZ2)&
  &*DBLE(MU**INT(4.D0)) + 24.D0*SW2*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(MU**INT(4.D0)) - 18.D0*DB0(x, MU2, MZ2)*DBLE(MZ**INT(4.D0)) + &
  &48.D0*SW2*DB0(x, MU2, MZ2)*DBLE(MZ**INT(4.D0)) - 32.D0*MZ2*DBLE(SW**INT(4.D0)) - 16.D0*A0(MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*A0(&
  &GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) - 32.D0*MU2*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MZ2*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D&
  &0)) + 32.D0*x*B0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 32.D0*MU2*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*GaugeXiZ*MZ&
  &2*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) - 32.D0*x*B0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MU2*MZ2*DB0(x, M&
  &U2, MZ2)*DBLE(SW**INT(4.D0)) - 32.D0*MU2*x*DB0(x, MU2, MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*MZ2*x*DB0(x, MU2, MZ2)*DBLE(SW**INT(4.&
  &D0)) + 16.D0*GaugeXiZ*MU2*MZ2*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 32.D0*MU2*x*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**I&
  &NT(4.D0)) + 16.D0*GaugeXiZ*MZ2*x*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0)) + 16.D0*DB0(x, MU2, MZ2)*DBLE(MU**INT(4.D0))*DB&
  &LE(SW**INT(4.D0)) - 16.D0*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(MU**INT(4.D0))*DBLE(SW**INT(4.D0)) - 32.D0*DB0(x, MU2, MZ2)*DBLE(MZ**&
  &INT(4.D0))*DBLE(SW**INT(4.D0)) + 9.D0*DB0(x, MU2, MZ2)*DBLE(x**INT(2.D0)) - 24.D0*SW2*DB0(x, MU2, MZ2)*DBLE(x**INT(2.D0)) - 9.&
  &D0*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 24.D0*SW2*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(x**INT(2.D0)) + 16.D0*DB0(x, MU2, M&
  &Z2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0)) - 16.D0*DB0(x, MU2, GaugeXiZ*MZ2)*DBLE(SW**INT(4.D0))*DBLE(x**INT(2.D0))))/(CW2*MZ2&
  &*PI2*SW2*x)

 amplitudes(13) = (-0.015625D0*CKM11*CKMC11*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MD2) + (MD2 + 2.D0*MW2 - 1.D0*x)*A&
  ...
  &625D0*CKM11*CKMC11*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MD2*B0(x, MD2, MW2) + MW2*B0(x, MD2, MW2) + 2.D0*x*&
 ...
 amplitudes(14) = (-0.015625D0*CKM12*CKMC12*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MS2) + (MS2 + 2.D0*MW2 - 1.D0*x)*A&
  ...
  &625D0*CKM12*CKMC12*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MS2*B0(x, MS2, MW2) + MW2*B0(x, MS2, MW2) + 2.D0*x*&
 ...
 amplitudes(15) = (-0.015625D0*CKM13*CKMC13*EL2*DBLE(x**INT(-2.D0))*(-2.D0*MW2*x - 2.D0*MW2*A0(MB2) + (MB2 + 2.D0*MW2 - 1.D0*x)*A&
  ...
  &625D0*CKM13*CKMC13*EL2*(-2.D0*MW2 - 1.D0*A0(MW2) + A0(GaugeXiW*MW2) - 2.D0*MB2*B0(x, MB2, MW2) + MW2*B0(x, MB2, MW2) + 2.D0*x*&
